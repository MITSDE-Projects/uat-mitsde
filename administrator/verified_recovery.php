                ...
                <div class="box-body">
                  <table id="example2" class="table table-bordered table-striped">
					...
					coursemaster.Cr_Name FROM transaction INNER JOIN coursemaster ON (coursemaster.CourseID = transaction.T_FeeID) INNER JOIN leadmaster ON (transaction.T_LeadID = leadmaster.LeadID)"); 	
                       ...
                       <tr>
                        <td><span style="color: #008313"></span><?php echo $set_T_data['T_LeadID'];?></td>
                        ...
                        <td><?php echo $set_T_data['UTR'];?></td>
                        <td><?php if($set_T_data['UTR']!=NULL) { echo "<span style='color:#008313'>verified</span>"; } else { echo "Not Verify"; }?></td>
