					...
					// echo "</br>SELECT * FROM tbl_transactions_details WHERE email='".$getmetadata['email']."' GROUP BY transaction_id ORDER BY id DESC";
					 ...
					 $gettransactiondtls = mysqli_query($conn,"SELECT * FROM tbl_transactions_details WHERE email='".$getmetadata['email']."'  ORDER BY id DESC");
                      ...
                      <tr>
						  ...
						  <td><?=$settransactiondtls['finance_charges'];?></td>
						  <td><?=$settransactiondtls['nbfc_name'];?></td>
						  <td><?=$settransactiondtls['tenure'];?></td>
          ...
          <div class="box-body">
                  <table id="example2" class="table table-bordered table-striped">
                    ...
                    <tbody>
                      ...
                      <td><input type="text"  name="finance_charges" class="form-control"  ></td>
                      
                      <td><select name="nbfc_name" id="nbfc_name" class="form-control" >
                          <option value="">Select NBFC Name</option>
                      ...
                      <td><input type="text"  name="tenure" class="form-control"  ></td>
