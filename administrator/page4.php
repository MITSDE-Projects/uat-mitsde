...
{
 	header("location: https://mitsde.com/administrator/list_rejected.php?formstatus=Payment done&enroll_bucket=1&reject=1");//redirecting to second page
}
else
{
...
<head>
  <title>MIT SDE 2018-19</title>
    <link rel="shortcut icon" href="https://mitsde.com/apply/images/favicon.ico" />
    <script type="text/javascript" src="https://mitsde.com/apply/js/bootstrap.min.js"></script>
	<script type="text/javascript" src="https://mitsde.com/apply/js/bootstrapValidator.min.js"></script> 
	<script src="https://mitsde.com/apply/js/jquery.min.js"></script>
	<script src="https://mitsde.com/apply/js/jquery-ui.js"></script>
	<link href="https://mitsde.com/apply/css/style.css" rel="stylesheet" />
	<link href="https://mitsde.com/apply/css/bootstrap.min.css" rel="stylesheet" />
	<script type="text/javascript" src="https://mitsde.com/apply/js/jquery.form.js"></script>
		<link rel="stylesheet" href="https://mitsde.com/apply/css/style.css" />
 		<script src="https://mitsde.com/apply/js/courses.js"></script>
 		<script src="https://mitsde.com/apply/js/common.js"></script>
