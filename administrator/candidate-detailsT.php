...
window.location.href='candidate-details.php?id='+id+'&allverfied=1';
      ...
      <div class="content-wrapper">
		...
		//die;
									 ...
									 $getsucc = mysqli_query($conn,"UPDATE student SET alternate_email='".$_POST['alternate_email']."',
									 ...
									 scorepostgraduation='".$_POST['scorepostgraduation']."' 
									 ...
									 WHERE memberID='".$_GET['id']."'");
										...
										if($getsucc){
										    ...
										    header('location:candidate-detailsT.php?msg=Updated&id='.$_GET['id']);
