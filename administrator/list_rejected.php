                  ...
                  <table id="example2" class="table table-bordered table-striped">
                    <thead>
                      <tr>
                        ...
                        <th style="min-width:100px;">Reg ID</th>
                        ...
                        <th style="min-width:100px;">Update Doc.</th>
					...
					?>
                      ...
                      <tr <?  if($setstuddata['is_reject']=='1') { ?> style="background-color:#FF7D33;";   <? } ?>>
		                
		                
		                <td style="min-width:100px;"><?=$setstuddata['memberID']?></td>
		                <td style="min-width:100px;"><?=$setstuddata['RegNo']?></td>
                        ...
                        <td style="min-width:100px;"><a href="https://mitsde.com/apply/page4.php?memberID=<?=$setstuddata['memberID']?>">Upload Doc.</a></td>
