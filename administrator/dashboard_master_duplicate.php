...
$enrollverifiedcnt = mysqli_fetch_assoc(mysqli_query($conn,"SELECT COUNT(*) AS cnt FROM student WHERE enrollment_verified!='1' AND is_reject!='1' AND is_doc_verified='1' AND enroll_bucket ='1'  AND lastpage='printformvalue.php' AND is_enrolled!='1'"));
          ...
          <section class="content">
               ...
               <?  if($_SESSION['user_id']!='10') { ?>
                     ...
                     <!-- Small boxes (Stat box) -->
                        ...
                        <div class="col-lg-2 col-xs-6">
                            ...
                            <div class="small-box bg-orange">
                                <div class="inner">
                                    ...
                                    <p><a href="list_application.php?formstatus=Payment done&accounts_pending=1" style="color:#FFF">Application Rejected</a></p>
                                </div>
                                <div class="icon">
                                    <i class="ion ion-pie-graph"></i>
                                </div>
                       ...
                       <? if($_SESSION['user_id']!='11' && $_SESSION['user_id']!='13' && $_SESSION['user_id']!='14') { ?>
                        <div class="col-lg-2 col-xs-6">
                            <!-- small box -->
                            <div class="small-box bg-red">
                                <div class="inner">
                        ...
                        <div class="col-lg-2 col-xs-6">
                            ...
                            <div class="small-box bg-black">
                                <div class="inner">
                                    <h3><?=$getrejectdata['cnt'];?></h3>
                                    <p><a href="list_application.php?formstatus=Payment done&enroll_bucket=1&reject=1" style="color:#FFF">Application Rejected</a></p>
                                </div>
                                <div class="icon">
                                    <i class="ion ion-pie-graph"></i>
                                </div>
                      ...
                      <div class="col-lg-2 col-xs-6">
                            ...
                            <div class="small-box bg-black">
                                <div class="inner">
                                    <h3><?=$getrejectdata['cnt'];?></h3>
                                    <p><a href="list_application.php?formstatus=Payment done&enroll_bucket=1&reject=1" style="color:#FFF">Laon Application</a></p>
                                </div>
                                <div class="icon">
                                    <i class="ion ion-pie-graph"></i>
                                </div>
                        ...
                        <div class="col-lg-2 col-xs-6">
                            ...
                            <div class="small-box bg-red">
                                <div class="inner">
                                    ...
                                    <p><a href="list_application.php?formstatus=Payment done&enroll_bucket=1&doc_veri_pend=1" style="color:#FFF">Doc Verftn Pndg</a></p>
                                </div>
                                <div class="icon">
                                    <i class="ion ion-pie-graph"></i>
                                </div>
                        ...
                        <div class="col-lg-2 col-xs-6">
                            ...
                            <div class="small-box bg-orange">
                                <div class="inner">
                                    ...
                                    <p><a href="list_application.php?formstatus=payment done&enrolldone=1" style="color:#FFF">Enrolled</a></p>
                                </div>
                                <div class="icon">
                                    <i class="ion ion-pie-graph"></i>
                                </div>
