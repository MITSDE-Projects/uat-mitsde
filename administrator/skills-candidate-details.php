          ...
          <div class="row">
						...
						<!-- form start -->
						  ...
						  <div class="box-body">
							...
							<input type="text" name="yearofpassing10" class="form-control" value="<?=$getmetadata['yearofpassing10']?>">
						 	...
						 	<!--<div class="form-group">
							  <label for="exampleInputEmail1">Other Qualification</label>
							<input type="text" name="otherqualification" class="form-control" value="<?//=$getmetadata['otherqualification']?>">
							</div>
							
							
							<div class="form-group">
							  <label for="exampleInputEmail1">Exam Other Qualificationr</label>
							<input type="text" name="examotherqualification" class="form-control" value="<?//=$getmetadata['examotherqualification']?>">
							</div>
							
							
							<div class="form-group">
							  <label for="exampleInputEmail1">Year of Passing Other Qualification</label>
							<input type="text" name="yearofpassingotherqualification" class="form-control" value="<?//=$getmetadata['yearofpassingotherqualification']?>">
							</div>
							
							
							
							<div class="form-group">
							  <label for="exampleInputEmail1">Score Other Qualification</label>
							<input type="text" name="scoreotherqualification" class="form-control" value="<?//=$getmetadata['scoreotherqualification']?>">
							</div>
							
							
							<div class="form-group">
							  <label for="exampleInputEmail1">Post Graduation</label>
							<input type="text" name="postgraduation" class="form-control" value="<?//=$getmetadata['postgraduation']?>">
							</div>
							
							<div class="form-group">
							  <label for="exampleInputEmail1">Exam Post Graduation</label>
							<input type="text" name="exampostgraduation" class="form-control" value="<?//=$getmetadata['exampostgraduation']?>">
							</div>
							
							<div class="form-group">
							  <label for="exampleInputEmail1">Year of Passing Post Graduation</label>
							<input type="text" name="yearofpassingpostgraduation" class="form-control" value="<?//=$getmetadata['yearofpassingpostgraduation']?>">
							</div>-->
							...
							<img src="https://mitskillsindia.edu.in/apply/<?php echo $getmetadatadoc['photo'];?>"  width="75" height="75" />
						    <a download href="https://mitskillsindia.edu.in/apply/<?php echo $getmetadatadoc['photo'];?>" >Download</a>
						
						
							</div>
							<div class="form-group">
							  <label for="exampleInputEmail1">Signature </label>
							<img src="https://mitskillsindia.edu.in/apply/<?php echo $getmetadatadoc['signature'];?>"  width="75" height="75" />
						    <a download href="https://mitskillsindia.edu.in/apply/<?php echo $getmetadatadoc['signature'];?>" >Download</a>
						
						
							</div>
							<div class="form-group">
							  <label for="exampleInputEmail1">SSC mark sheet </label>
							<a href="https://mitskillsindia.edu.in/apply/<?php echo $getmetadatadoc['ssc'];?>" target="_blank">Click for Document</a>
								<img src="https://mitskillsindia.edu.in/apply/<?php echo $getmetadatadoc['ssc'];?>"  width="75" height="75" />
							</div>
				
							
							<div class="form-group">
							  <label for="exampleInputEmail1">Graduation Certificate</label>
							<a href="https://mitskillsindia.edu.in/apply/<?php echo $getmetadatadoc['graduationcertificate'];?>" target="_blank">Click for Document</a>
							<?php if(!empty($getmetadatadoc['graduationcertificate']))
							   {
							       ?>
							       <img src="https://mitskillsindia.edu.in/apply/<?php echo $getmetadatadoc['graduationcertificate'];?>"  width="75" height="75" />
							       <?php
							   }
						...
						<!-- form start -->
						  ...
						  <div class="box-body">
						   ...
						   <div class="form-group">
							...
							<a href="https://mitskillsindia.edu.in/apply/<?php echo $getmetadatadoc['entrance'];?>" target="_blank">Click for Document</a>
							<?php if(!empty($getmetadatadoc['entrance']))
							   {
							       ?>
							       <img src="https://mitskillsindia.edu.in/apply/<?php echo $getmetadatadoc['entrance'];?>"  width="75" height="75" />
							       <?php
							   }
							...
							<a href="https://mitskillsindia.edu.in/apply/<?php echo $getmetadatadoc['hsc'];?>" target="_blank">Click for Document</a>
							<?php if(!empty($getmetadatadoc['hsc']))
							   {
							       ?>
							       <img src="https://mitskillsindia.edu.in/apply/<?php echo $getmetadatadoc['hsc'];?>"  width="75" height="75" />
							       <?php
							   }
							...
							<a href="https://mitskillsindia.edu.in/apply/<?php echo $getmetadatadoc['identity'];?>" target="_blank">Click for Document</a>
							<?php if(!empty($getmetadatadoc['identity']))
							   {
							       ?>
							       <img src="https://mitskillsindia.edu.in/apply/<?php echo $getmetadatadoc['identity'];?>"  width="75" height="75" />
							       <?php
							   }
							...
							<div class="form-group">
							  ...
							  <a href="https://mitskillsindia.edu.in/apply/<?php echo $getmetadatadoc['graduationcertificate_sem1'];?>" target="_blank">Click for Document</a>
							  <?php if(!empty($getmetadatadoc['graduationcertificate_sem1']))
							   {
							       ?>
							       <img src="https://mitskillsindia.edu.in/apply/<?php echo $getmetadatadoc['graduationcertificate_sem1'];?>"  width="75" height="75" />
							       <?php
							   }
							...
							<div class="form-group">
							  ...
							  <a href="https://mitskillsindia.edu.in/apply/<?php echo $getmetadatadoc['graduationcertificate_sem2'];?>" target="_blank">Click for Document</a>
							  <?php if(!empty($getmetadatadoc['graduationcertificate_sem2']))
							   {
							       ?>
							       <img src="https://mitskillsindia.edu.in/apply/<?php echo $getmetadatadoc['graduationcertificate_sem2'];?>"  width="75" height="75" />
							       <?php
							   }
							...
							<div class="form-group">
							  ...
							  <a href="https://mitskillsindia.edu.in/apply/<?php echo $getmetadatadoc['graduationcertificate_sem3'];?>" target="_blank">Click for Document</a>
							  <?php if(!empty($getmetadatadoc['graduationcertificate_sem3']))
							   {
							       ?>
							       <img src="https://mitskillsindia.edu.in/apply/<?php echo $getmetadatadoc['graduationcertificate_sem3'];?>"  width="75" height="75" />
							       <?php
							   }
							...
							<div class="form-group">
							  ...
							  <a href="https://mitskillsindia.edu.in/apply/<?php echo $getmetadatadoc['graduationcertificate_sem4'];?>" target="_blank">Click for Document</a>
							   <?php if(!empty($getmetadatadoc['graduationcertificate_sem4']))
							   {
							       ?>
							       <img src="https://mitskillsindia.edu.in/apply/<?php echo $getmetadatadoc['graduationcertificate_sem4'];?>"  width="75" height="75" />
							       <?php
							   }
							...
							<div class="form-group">
							  ...
							  <a href="https://mitskillsindia.edu.in/apply/<?php echo $getmetadatadoc['graduationcertificate_sem5'];?>" target="_blank">Click for Document</a>
							  <?php if(!empty($getmetadatadoc['graduationcertificate_sem5']))
							   {
							       ?>
							       <img src="https://mitskillsindia.edu.in/apply/<?php echo $getmetadatadoc['graduationcertificate_sem5'];?>"  width="75" height="75" />
							       <?php
							   }
							...
							<div class="form-group">
							  ...
							  <a href="https://mitskillsindia.edu.in/apply/<?php echo $getmetadatadoc['graduationcertificate_sem6'];?>" target="_blank">Click for Document</a>
							  <?php if(!empty($getmetadatadoc['graduationcertificate_sem6']))
							   {
							       ?>
							       <img src="https://mitskillsindia.edu.in/apply/<?php echo $getmetadatadoc['graduationcertificate_sem6'];?>"  width="75" height="75" />
							       <?php
							   }
							...
							<div class="form-group">
							  ...
							  <a href="https://mitskillsindia.edu.in/apply/<?php echo $getmetadatadoc['graduationcertificate_sem7'];?>" target="_blank">Click for Document</a>
							   <?php if(!empty($getmetadatadoc['graduationcertificate_sem7']))
							   {
							       ?>
							       <img src="https://mitskillsindia.edu.in/apply/<?php echo $getmetadatadoc['graduationcertificate_sem7'];?>"  width="75" height="75" />
							       <?php
							   }
							...
							<div class="form-group">
							  ...
							  <a href="https://mitskillsindia.edu.in/apply/<?php echo $getmetadatadoc['graduationcertificate_sem8'];?>" target="_blank">Click for Document</a>
							  <?php if(!empty($getmetadatadoc['graduationcertificate_sem8']))
							   {
							       ?>
							       <img src="https://mitskillsindia.edu.in/apply/<?php echo $getmetadatadoc['graduationcertificate_sem8'];?>"  width="75" height="75" />
							       <?php
							   }
							...
							<div class="form-group">
							  ...
							  <a href="https://mitskillsindia.edu.in/apply/<?php echo $getmetadatadoc['application_form'];?>" target="_blank">Click for Document</a>
							  <?php if(!empty($getmetadatadoc['application_form']))
							   {
							       ?>
							       <img src="https://mitskillsindia.edu.in/apply/<?php echo $getmetadatadoc['application_form'];?>"  width="75" height="75" />
							       <?php
							   }
							...
							<div class="form-group">
							  ...
							  <a href="https://mitskillsindia.edu.in/apply/<?php echo $getmetadatadoc['undertaking_form'];?>" target="_blank">Click for Document</a>
							   <?php if(!empty($getmetadatadoc['undertaking_form']))
							   {
							       ?>
							       <img src="https://mitskillsindia.edu.in/apply/<?php echo $getmetadatadoc['undertaking_form'];?>"  width="75" height="75" />
							       <?php
							   }
							...
							<div class="form-group">
							  ...
							  <a href="https://mitskillsindia.edu.in/apply/<?php echo $getmetadatadoc['experience'];?>" target="_blank">Click for Document</a>
							   <?php if(!empty($getmetadatadoc['experience']))
							   {
							       ?>
							       <img src="https://mitskillsindia.edu.in/apply/<?php echo $getmetadatadoc['experience'];?>"  width="75" height="75" />
							       <?php
							   }
            ...
            <!-- right column -->
              ...
              <td><? if($settransactiondtls['ins_2_date']=='0000-00-00') { echo $settransactiondtls['ins_1_date'];  } else { echo $settransactiondtls['ins_2_date']; }?></td>
                       ...
                       <td>
                       <?
						   if($settransactiondtls['UTR_number']!="")
						   {
							   ?>
							   <label style="color:#00C140">Verified By A/c</label>
							   <?
						   }
						   else
						   {
							...
							<label style="color:#C80003" >Veryfication Pending</label>   
					      <?
						   }
