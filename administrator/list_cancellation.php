              ...
              <div class="box">
                ...
                <div class="box-body">
                  <table id="example2" class="table table-bordered table-striped">
					...
					$getstuddata = mysqli_query($conn,"SELECT * FROM student WHERE Cancellation ='1' ORDER BY memberID DESC"); 
					     $id =1;
					...
					?>
                      ...
                      <tr   <? if($setstuddata['is_reject']=='1'  && $setstuddata['is_enrolled']!='1') { ?> style="background-color:#FF0000;";   <? } ?>>
		                <td><? if($setstuddata['is_enrolled']=='1') { echo "Enrollment Complete"; } else if($setstuddata['enroll_bucket']=='1' && $setstuddata['is_enrolled']!='1') { echo "Enrollment In-Process";  } else { echo "---"; } ?></td><td style="min-width:200px;"><?=$setstuddata['memberID']?></td>
		                <? if($accessrights['account_verification']=='1') { ?>
