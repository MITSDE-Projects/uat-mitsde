...
<head>
   ...
   <link rel="canonical" href="https://mitsde.com/sample_certificate" />
    ...
    <meta property="og:url" content="https://mitsde.com/sample_certificate">
    ...
    <main class="main-body">
        ...
        <section id="learnExpert">
            <div class="container">
                ...
                <div class="parent">
                    <div class="card">
                        <img src="./assets/images/media/sample-certificate/1.jpg" alt="Webinar Image"
                            class="card-img-top">

                    </div>
                    <div class="card">
                        <img src="./assets/images/media/sample-certificate/2.jpg" alt="Webinar Image"
                            class="card-img-top">

                    </div>
                    <div class="card">
                        <img src="./assets/images/media/sample-certificate/3.jpg" alt="Webinar Image"
                            class="card-img-top">
