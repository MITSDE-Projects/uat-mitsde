...
echo "</br>firstname-->".$first_name = htmlspecialchars(trim(stripslashes($_POST['first_name3'])), ENT_QUOTES, 'UTF-8');

 // Sanitize email input
 echo "</br>Email-->".   $email = filter_var($_POST['email3'], FILTER_SANITIZE_EMAIL);
$emaiid=$_POST['email3'];
//$mobile=$_POST['MobileNumber'];
echo "</br>MobileNumber-->". $mobile = filter_var($_POST['MobileNumber'], FILTER_SANITIZE_NUMBER_INT);
