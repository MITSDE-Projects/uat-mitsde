...
<div id="firstform">
    ...
    <div class="col-md-12 col-lg-12 bg-dark p-3 " style="border-radius: 5px;">
        ...
        <form action="../thankyou.php" method="post" class="reservation-form mt-20 myFormH" accept-charset="utf-8"
            ...
            <div class="form-group ">
                ...
                <button type="button" id="submitbtnsticky" class="btn btn-main mit-button mit-footer btn-ripple w-100 "
