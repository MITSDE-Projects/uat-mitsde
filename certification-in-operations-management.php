...
<head>
    ...
    "itemListElement": [
        ...
        "@type": "ListItem",
        "position": 2,
        "name": "Certification in Operations Management",
  ...
  <?php include "5-common-seo-tag-2.php" ?>
    ...
    <section class="hero ph-hero">
        <nav class="page-breadcrumb" aria-label="Breadcrumb">
            ...
            <a href="#">PCP</a>
            <span class="pb-sep">/</span>
            <span class="pb-current">Certification in Operations Management</span>
        </nav>
        <div class="container">
            ...
            <div class="ph-layout">
                ...
                <!-- Left — heading -->
                <div class="ph-left">
                    <h1 class="ph-heading">Professional Certification<br> In Operations Management</h1>
                </div>
            ...
            <div class="ph-specs-wrap">
                <div class="ph-specs">
                    ...
                    <a href="certification-in-operations-management"><button class="ph-spec-pill is-active">Operations Management</button></a>
                ...
                <div class="learning-outcomes-right">
                    <ul class="learning-outcomes-list">
                        ...
                        <li>
                            ...
                            <span>Understand business operations and process optimization</span>
                        </li>
                        <li>
                            <i class="fa-regular fa-square-check"></i>
                            <span>Learn supply chain basics and quality management</span>
                        </li>
                        <li>
                            <i class="fa-regular fa-square-check"></i>
                            <span>Gain knowledge of efficiency and productivity improvement</span>
                        </li>
                    </ul>
                </div>
                    ...
                    <div class="faq-list">
                        ...
                        <div class="faq-item is-open">
                            ...
                            <div class="faq-a" style="background: transparent;">
                                <p class="text-dark">Completing a certification course in operations management can open up various career opportunities across multiple industries, such as:</p>
                                <ul class="ac-list text-dark">
                                    <li>Operations Executive</li>
                                    <li>Process Coordinator</li>
    ...
    <section class="sam-certificate-section" id="certificate">
        <div class="container">
            ...
            <div class="cert-img">
                <img class="img-fluid" src="assets-new/images/certificate/certification-in-operations-management-cer.webp" alt="Certificate in Operation Management" loading="lazy">
            </div>
        </div>
    </section>
