    ...
    <div class="container">
        <div class="row res-row">
                    ...
                    <div class="col-md-6 col-6 pink">
                        ...
                        <ul>
                            ...
                            <li><a class="dropdown-item" href="mandatory-disclosure" target="_blank">Mandatory
                                    Disclosure</a></li>
                            <li><a class="dropdown-item" href="https://myaccount.mitsde.com/" target="_blank">My Account</a></li>
                ...
                <div class="cc-list">
                    ...
                    <div class="cc-details mt-3">
                        <span class="mtsk-phone">
                            <a href="tel:9112207207" style="text-decoration: none; color: black;">9112207207</a>
            ...
            <div class="bottom-footer">
                <p class="right-reserved">© Copyright 2026. All Rights Reserved by MIT School of Distance Education</p>
...
<div class="modal enquiry fade" id="enquiryModal-download-form" tabindex="-1" aria-labelledby="enquiryModalLabel"
    aria-hidden="true">
    <?php include "download-popup-form.php" ?>
</div>
