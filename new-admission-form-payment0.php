...
$result1 = mysql_query("SELECT * FROM New_student_admission_transaction WHERE t_process_id = '" . $transactionId . "'");
...
<head>
    ...
    <script type="text/javascript">
        ...
        function validate(form) {
            ...
            var Specialization = form.merchant_param4.value.trim();
            var Counselor = form.merchant_param2.value.trim();
...
<body>
            ...
            <div class="row d-flex justify-content-center">
                <div class="col-xl-7 col-lg-8 col-md-9 col-11 text-center">
                    ...
                    <div class="card">
                        ...
                        <form action="ccavRequestHandler02New.php" name="OtherFeesPayment" id="OtherFeesPayment"
                            ...
                            <input type="hidden" name="redirect_url" id="redirect_url"
                                value="https://mitsde.com/ccavResponseHandler01New.php" />
                            ...
                            <div class="row justify-content-between text-left">
                                ...
                                <div class="form-group col-sm-6 flex-column d-flex mt-2">
                                    <input type="text" class="form-control" name="delivery_name" id="StudentName"
                            ...
                            <div class="row justify-content-between text-left">
                                <div class="form-group col-sm-6 flex-column d-flex mt-2">
                                    <input type="text" class="form-control" name="billing_email" id="EmailID"
                                ...
                                <div class="form-group col-sm-6 flex-column d-flex mt-2">
                                    <div class="form-group"><input type="text" class="form-control" name="delivery_tel"
                                            id="MobileNo" value="" placeholder="Mobile No"> </div>
                                </div>
                                ...
                                <div class="form-group col-sm-6 flex-column d-flex mt-2">
                                    ...
                                    <select class="form-select form-select-md" name="merchant_param1"
                                        ...
                                        <?php
                                        $getCourses = mysql_query("SELECT * FROM `NewCourseERP`");
                                ...
                                <div class="form-group col-sm-6 flex-column d-flex mt-2">
                                    <select class="form-select" data-live-search="true" name="merchant_param2"
                                        id="merchant_param2">
                                        <option value="">Select Counselor</option>
                                        <!-- <option value="Sanjay">Sanjay</option> -->
                                        <?php
                                        $getCounselors = mysql_query("SELECT * FROM `tbl_counselor`");
    ...
    <script>
        function getSpecializations(courseName) {
            if (courseName == "") {
                document.getElementById("merchant_param4").innerHTML = "<option value=''>Select Specialization</option>";
                return;
            }

            var xhr = new XMLHttpRequest();
            xhr.open("GET", "get_specializations_new.php?CourseName=" + courseName, true);
            xhr.onreadystatechange = function () {
                if (xhr.readyState == 4 && xhr.status == 200) {
                    document.getElementById("merchant_param4").innerHTML = xhr.responseText;
                }
            };
            xhr.send();
        }
