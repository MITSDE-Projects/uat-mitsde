...
<div class="col-md-12 col-lg-4 d-flex justify-content-evenly" style="height:max-content;" id="firstform">
        <form action="thankyou.php" method="post" class="reservation-form mt-20 myFormH w-100" style="border-radius: 5px; background:#F47521;  padding: 10px"  accept-charset="utf-8"
            ...
            <div class="form-check">
                ...
                <small class="text-white" style="font-size: 7px;">I authorize MIT-SDE representative to contact me,this will override DND/NDNC
                    registry.</small>
            </div>
