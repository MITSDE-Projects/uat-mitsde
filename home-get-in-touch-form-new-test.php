...
<div class="col-md-12 col-lg-4 d-flex justify-content-evenly " id="firstform2">

    <div class="col-md-12 col-lg-12 ">
        <h6 class="text-dark text-center">Quick Contact </h6>
        ...
        <form action="thankyou.php" method="post" class="reservation-form mt-20 myFormH" accept-charset="utf-8"
            ...
            <select name="HQ" id="HQ" class="form-select form-control mb-3"
                onBlur="javascript:addDefault(this,'menuContactFloting')" onFocus="javascript:removeDefault(this)"
            ...
            <div class="form-check">
                ...
                <small class="text-dark" style="font-size: 8px;">I authorize MIT-SDE representative to contact me,this
                    will
                    override
                    DND/NDNC
                    registry.</small>
