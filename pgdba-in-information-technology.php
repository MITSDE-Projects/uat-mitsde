...
<head>
    ...
    <title>PGDBA in Information Technology | Online PG course in IT</title>
    ...
    <meta name="keywords"
        content="IT courses, MBA IT, PG diploma in IT management, pgdba in Information Technology management, post graduate diploma in business administration, IT management courses,pgdba" />

    <!-- CANONICAL TAG -->

    <link rel="canonical" href="https://mitsde.com/pgdba-in-information-technology" />

    <!-- CANONICAL TAG -->

    <!-- OGP TAG -->

    <meta property="og:title" content="PGDBA in Information Technology | Online PG course in IT">
    <meta property="og:site_name" content="MIT School of Distance Education">
    <meta property="og:url" content="https://mitsde.com/pgdba-in-information-technology">
    ...
    <script type="application/ld+json">
        {
            ...
            "offers": {
                "@type": "Offer",
                "url": "https://mitsde.com/pgdba-in-information-technology",
                "priceCurrency": "INR",
                "price": "95000",
    ...
    <script type="application/ld+json">
        {
            ...
            "itemListElement": [{
                ...
                },
                {
                    "@type": "ListItem",
                    "position": 3,
                    "name": "PGDBA Information Technology",
                    "item": "https://mitsde.com/pgdba-in-information-technology"
                }
            ]
        }
    </script>
    ...
    <script type="application/ld+json">
        {
            ...
            "mainEntity": [{
                    "@type": "Question",
                    "name": "What is the duration of the PGDBA in Information Technology program?",
                    "acceptedAnswer": {
                        "@type": "Answer",
                        "text": "The program lasts for 24 months."
                    }
                },
                {
                    "@type": "Question",
                    "name": "What is the eligibility requirement for this course?",
                    "acceptedAnswer": {
                        "@type": "Answer",
                        "text": "Any graduate is eligible to apply."
                    }
                },
                {
                    "@type": "Question",
                    ...
                    "acceptedAnswer": {
                        "@type": "Answer",
                        "text": "The fee for the program is ₹95,000."
                    }
                },
                {
                    "@type": "Question",
                    "name": "What subjects are covered in the first semester?",
                    "acceptedAnswer": {
                        "@type": "Answer",
                        "text": "Subjects include Principles of Management, Business Communication, Marketing Management, and others."
                    }
                },
                {
                    "@type": "Question",
                    "name": "Is the course offered online?",
                    "acceptedAnswer": {
                        "@type": "Answer",
                        "text": "Yes, the course is offered online."
                    }
                },
                {
                    "@type": "Question",
                    "name": "What is the assessment method for the course?",
                    "acceptedAnswer": {
                        "@type": "Answer",
                        "text": "Exams consist of multiple-choice questions, with both internal and external assessments."
                    }
                },
                {
                    "@type": "Question",
                    "name": "Can I specialize in a particular area?",
                    "acceptedAnswer": {
                        "@type": "Answer",
                        "text": "Yes, there are elective options in areas like HR Analytics, Marketing Analytics, etc."
                    }
                },
                {
                    "@type": "Question",
                    ...
                    "acceptedAnswer": {
                        "@type": "Answer",
                        "text": "Scholarships are available; check with the admissions office for details."
                    }
                },
                {
                    "@type": "Question",
                    "name": "What is the curriculum for the IT-related subjects?",
                    "acceptedAnswer": {
                        "@type": "Answer",
                        "text": "Subjects include Database Management, IT Security, and Object-Oriented Design."
                    }
                },
                {
                    "@type": "Question",
                    ...
                    "acceptedAnswer": {
                        "@type": "Answer",
                        "text": "The course includes four semesters with a combination of core and elective subjects, and a project work component."
                    }
                }
            ]
        }
  ...
  <?php include "5-common-seo-tag-2.php" ?>
    ...
    <section class="hero ph-hero">
        <nav class="page-breadcrumb" aria-label="Breadcrumb">
            ...
            <span class="pb-sep">/</span>
            <span class="pb-current">PGDBA In Information Technology</span>
        </nav>
        <div class="container">
            ...
            <div class="ph-layout">
                ...
                <div class="ph-left">
                    <h1 class="ph-heading">Online PGDBA Course<br>In Information Technology</h1>
                </div>
            ...
            <div class="ph-specs-wrap">
                <div class="ph-specs">
                    ...
                    <a href="pgdba-in-information-technology"><button class="ph-spec-pill is-active">Information Technology</button></a>
    ...
    <section class="about-section pb-0" id="about">
        ...
        <div class="container">
            ...
            <p>
                <b>Information technology, often shortened to just IT – is the fastest-growing sector today.</b> With the
                constantly changing business models and operations, there is a constant need for the evolution of
                technology up-gradation and updation of technology in an organization to ensure its competitiveness. The
                market is abuzz with software development programs, Artificial Intelligence (AI), Cloud computing, Big
                Data, Database Management systems. In view of the rapid changes, there is a huge demand for highly
                qualified innovative IT professionals all across the globe.
            </p>

            <p>
                The <b>PG Diploma in Business Administration with specialization in Information Technology</b> introduces
                you to the latest terms, trends and concepts prevalent in today's IT industry. It equips you with the
                requisite knowledge and practical skills and prepares you for absorption in the industry. Thus, the
                comprehensive <b>course takes you into the all-embracing world of technology, information, and strategic
                    management.</b>
            </p>
                ...
                <div class="learning-outcomes-right">
                    <ul class="learning-outcomes-list">
                        <li>
                            ...
                            <span>Foster analytical thinking skills to solve complex problems</span>
                        </li>
                        <li>
                            <i class="fa-regular fa-square-check"></i>
                            <span>Deep understanding of the Information Technology sector and its core concepts</span>
                        </li>
                        <li>
                            <i class="fa-regular fa-square-check"></i>
                        ...
                        <div class="pgcs-top">
                            <div class="pgcs-left">
                                ...
                                <ul class="pgcs-course-list">
                                    ...
                                    <li>Database Management Systems (S3M01)</li>
                                    <li>Project Management (S3C13)</li>
                                    <li>Object Oriented Analysis &amp; Designing (OOA) (S3IT2)</li>
                                    <li>Operating Systems (S4M13)</li>
                        ...
                        <div class="pgcs-top">
                            <div class="pgcs-left">
                                ...
                                <ul class="pgcs-course-list">
                                    ...
                                    <li>Networking Concepts (S4M11)</li>
                                    <li>Advanced Networking (S3M04)</li>
                                    <li>IT Security (S3IT5)</li>
                ...
                <div class="fs-note-wrap">
                    ...
                    <div class="faq-list">
                        ...
                        <div class="faq-item">
                            ...
                            <div class="faq-a" style="background: transparent;">
                                <p class="text-dark">This wide-ranging course is a gateway to the IT departments of
                                ...
                                <ul class="ac-list text-dark">
                                    ...
                                    <li>Computer Forensic Investigator</li>
                                    <li>Mobile Application Developer</li>
                                    <li>Web Developer</li>
                                    <li>Health IT Specialist</li>
                                    <li>Software Engineer</li>
                                    <li>IT Vendor Management</li>
                                    <li>Geospatial Professionals</li>
                                    <li>Data Modeler</li>
                                </ul>
                            </div>
                        </div>
            ...
            <div class="faq-list">
                ...
                <div class="faq-item is-open">
                    <button class="faq-q" aria-expanded="true">
                        <span>What is the duration of the PGDBA in Information Technology program?</span>
                ...
                <div class="faq-item">
                    <button class="faq-q" aria-expanded="false">
                        <span>What is the eligibility requirement for this course?</span>
                        <svg class="faq-chevron" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path d="M6 9l6 6 6-6" stroke="currentColor" stroke-width="2" stroke-linecap="round"
                                stroke-linejoin="round" />
                        </svg>
                    ...
                    <div class="faq-a">
                        <p>Any graduate is eligible to apply.</p>
                    </div>
                </div>
                ...
                <div class="faq-item">
                    ...
                    <div class="faq-a">
                        <p>The fee for the program is ₹95,000.</p>
                    </div>
                </div>

                <div class="faq-item">
                    <button class="faq-q" aria-expanded="false">
                        <span>What subjects are covered in the first semester?</span>
                        <svg class="faq-chevron" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path d="M6 9l6 6 6-6" stroke="currentColor" stroke-width="2" stroke-linecap="round"
                                stroke-linejoin="round" />
                        </svg>
                    ...
                    <div class="faq-a">
                        <p>Subjects include Principles of Management, Business Communication, Marketing Management, and
                            others.</p>
                    </div>
                </div>
                ...
                <div class="faq-item">
                    <button class="faq-q" aria-expanded="false">
                        <span>Is the course offered online?</span>
                        <svg class="faq-chevron" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path d="M6 9l6 6 6-6" stroke="currentColor" stroke-width="2" stroke-linecap="round"
                                stroke-linejoin="round" />
                        </svg>
                    ...
                    <div class="faq-a">
                        <p>Yes, the course is offered online.</p>
                    </div>
                </div>

                <div class="faq-item">
                    <button class="faq-q" aria-expanded="false">
                        <span>What is the assessment method for the course?</span>
                        <svg class="faq-chevron" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path d="M6 9l6 6 6-6" stroke="currentColor" stroke-width="2" stroke-linecap="round"
                                stroke-linejoin="round" />
                        </svg>
                    ...
                    <div class="faq-a">
                        <p>Exams consist of multiple-choice questions, with both internal and external assessments.</p>
                    </div>
                </div>

                <div class="faq-item">
                    <button class="faq-q" aria-expanded="false">
                        <span>Can I specialize in a particular area?</span>
                        <svg class="faq-chevron" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path d="M6 9l6 6 6-6" stroke="currentColor" stroke-width="2" stroke-linecap="round"
                                stroke-linejoin="round" />
                        </svg>
                    ...
                    <div class="faq-a">
                        <p>Yes, there are elective options in areas like HR Analytics, Marketing Analytics, etc.</p>
                    </div>
                </div>
                ...
                <div class="faq-item">
                    ...
                    <div class="faq-a">
                        <p>Scholarships are available; check with the admissions office for details.</p>
                    </div>
                </div>

                <div class="faq-item">
                    <button class="faq-q" aria-expanded="false">
                        <span>What is the curriculum for the IT-related subjects?</span>
                        <svg class="faq-chevron" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path d="M6 9l6 6 6-6" stroke="currentColor" stroke-width="2" stroke-linecap="round"
                                stroke-linejoin="round" />
                        </svg>
                    ...
                    <div class="faq-a">
                        <p>Subjects include Database Management, IT Security, and Object-Oriented Design.</p>
                    </div>
                </div>

                <div class="faq-item">
                    <button class="faq-q" aria-expanded="false">
                        <span>How is the course structured?</span>
                        <svg class="faq-chevron" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path d="M6 9l6 6 6-6" stroke="currentColor" stroke-width="2" stroke-linecap="round"
                                stroke-linejoin="round" />
                        </svg>
                    ...
                    <div class="faq-a">
                        <p>The course includes four semesters with a combination of core and elective subjects, and a
                            project work component.</p>
                    </div>
                </div>
