        ...
        <div class="modal-body">
            <div class="row">
                <div class="col-md-12 col-lg-5 modal-img">
                    <img src="assets/images/enquirey.png" class="img-fluid" alt="Student enquiry and contact form illustration">
                </div>
                <div class="col-md-12 col-lg-7">
                    <form action="thankyou.php" method="post" name="QuickContact3" id="QuickContact3">
