...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if ($_POST['billing_email'] != '' and $_POST['delivery_tel'] != '' and $_POST['amount'] != '') {
        ...
        if ($LeadID != $EELeadID) {
            ...
            echo "</br><center><a href='https://www.mitsde.com/uat-erp-form-payment'>Go Back</a></center>";
    ...
    echo "</br><a href='https://www.mitsde.com/uat-erp-form-payment'>Go Back</a>";
...
$orchk = mysql_num_rows(mysql_query("select * from uat_erp_transaction where `t_process_id`='" . $transactionId . "'"));
...
if ($orchk > 0) {
    ...
    echo "<a href='https://www.mitsde.com/uat-erp-form-payment'>Go Back</a>";

    die;

} else {

    // echo "</br>INSERT INTO `temp_erp` (`T_ID`, `T_LeadID`,`student_name`,`email_id`,`phone`, `gender`, `course`,`SpecializationID`,`password`,`fees_type`, `T_installmentNo`, `T_A_Amount`, `T_B_Amount`, `tranID`, `P_Start_date`, `P_End_date`, `Status`,`gateway_name`, `old_counselorName`, `new_counselorName`, `flag`) VALUES (NULL, '" . $LeadID . "','" . $student_name . "','" . $Email . "','" . $MobileNo . "','" . $gender . "', '" . $Course . "','" . $S_ID . "','" . $Password . "','" . $FeesType . "', '0', '0', '" . $totamt . "', '" . $transactionId . "', '" . $CurrentDateTime . "', NULL, 'processing', 'HDFC', '" . $old_counselorName . "', '" . $new_counselorName . "', '0')";

    // die;

    $query = "INSERT INTO `temp_erp` (`T_ID`, `T_LeadID`,`student_name`,`email_id`,`phone`, `gender`, `course`,`SpecializationID`,`dual_SpecializationID`,`password`,`fees_type`, `T_installmentNo`, `T_A_Amount`, `T_B_Amount`, `tranID`, `P_Start_date`, `P_End_date`, `Status`,`gateway_name`, `old_counselorName`, `new_counselorName`, `flag`) VALUES (NULL, '" . $LeadID . "','" . $student_name . "','" . $Email . "','" . $MobileNo . "','" . $gender . "', '" . $Course . "','" . $S_ID . "','" . $dual_S_ID . "','" . $Password . "','" . $FeesType . "', '0', '0', '" . $totamt . "', '" . $transactionId . "', '" . $CurrentDateTime . "', NULL, 'processing', 'HDFC', '" . $old_counselorName . "', '" . $new_counselorName . "', '0')";
