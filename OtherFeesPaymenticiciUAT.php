...
$accessToken = "5YmjuWn2XcWvGPSX36yAHQ31nEuvwc9QdIxPnbVkFFUxOHx1o9VLuMe9VMlNGz2WpvJCoPf4FIy79JlKU0jdmGfFNMMwsnhWivkzqR8kdiwdOWU3ioj__JFSKkaxk-WOrjwdchQT3E37Rb9NgaIr9TjOlcxcX9jCru-bvP8WmOh8Kn4rJ7FQL3V3RIIRCbwwtxL0fj851PM-zXFJqhHyFMdBilR6drpzvbAprW-3RS8XViNZsIcyC2CeVLQ5gHCh8t5pl79VV3_otvQ5XCiRpfNb0VIVzGuDI11XAp-kixQJeF_AAvS-kX0-4GCABO2mB2CaLDBtYu7up7RZ0s4twuchhGxA8PZ4b-d-ArKpSSzAtIlS464VopBprcgfXfSXFasAKd_wnePcTJoNBZfoVlAFT10j0BbDp4PqUMQdHm9zLmMQAdq2w9FsguUCvSOAEBthcG1HghfwqEYRlv2XHTLRWL2bQPz4APGZpUo3nZQ"; // Replace with your actual token
...
function sendtoreject(value, id) {
    // alert(id);
    // alert(value);
    window.location.href = 'OtherFeesPaymenticiciUAT.php?studentid=' + value;
...
<head>
    ...
    <link rel="canonical" href="https://mitsde.com/OtherFeesPaymenticiciUAT" />
            ...
            <div class="row d-flex justify-content-center">
                <div class="col-xl-7 col-lg-8 col-md-9 col-11 text-center">
                    ...
                    <div class="card">
                        ...
                        <form action="ccavRequestHandlericiciUAT.php" name="OtherFeesPayment" id="OtherFeesPayment"
                            ...
                            <input type="hidden" name="redirect_url" id="redirect_url"
                                value="https://mitsde.com/ccavResponseHandlericiciUAT.php" />
