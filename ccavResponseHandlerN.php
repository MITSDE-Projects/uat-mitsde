...
error_reporting(0);
   ...
   //	$workingKey='FF2048EE9548EAE83BF4797292611691';		//testing
	...
	$dataSize=sizeof($decryptValues);
	 ...
	 /*$course_id=explode('=',$decryptValues[29]);  // course id for new ERP merchant_param4
     $course_id[1];*/
  ...
  <div class="main-content">
	...
	for($i = 0; $i < $dataSize; $i++) 
	{
		...
		if($i==3)	$order_status=$information[1];
          ...
          //$order_status="Success";  // for testing you can comment out it
       ...
       if($order_status==="Success")
	{
		...
		if($orchk>0 || $trchk >0 )
		  ...
		  elseif($temp1['tranID'] !=$oderID[1] || $temp1['T_B_Amount'] != $dotamt[0] )
		     ...
		     {
		         //echo "</br>SELECT * FROM `feeshead_new_erp` WHERE `description` = '".$temp1['fees_type']."'";
		         $GetFeeType = mysql_query("SELECT * FROM `feeshead_new_erp` WHERE `description` = '".$temp1['fees_type']."'");
	              ...
	              {
	               echo "</br>ReceiptType1-->".    $ReceiptType="PRF";
	              }
	              else
	              {
	               echo "</br>ReceiptType2-->".    $ReceiptType="OC";  
	              }
