    ...
    <div class="d-flex justify-content-end">
        <div class="lead-form">
            ...
            <form action="https://uat.mitsde.com/mitsde-form/thankyou.php" method="post"
                ...
                <script>
                (function () {
                    var form = document.getElementById('contactformAddmission');
                    ...
                    var stream = form.querySelector('select[name="stream"]');
                    var experience = form.querySelector('select[name="experience"]');
                    ...
                    [state, hq, stream, experience].forEach(function (el) {
