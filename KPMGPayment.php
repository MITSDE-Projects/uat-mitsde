...
$stmt = $conn->prepare("SELECT 1 FROM OtherFeesTransaction WHERE t_process_id = ?");
...
function sendtoreject(value, id) {
    // alert(id);
    // alert(value);
    window.location.href = 'KPMGPayment.php?studentid=' + value;
...
<head>
    ...
    <link rel="canonical" href="https://mitsde.com/KPMGPayment" />
    ...
    <meta property="og:url" content="https://mitsde.com/KPMGPayment">
            ...
            <div class="row d-flex justify-content-center">
                <div class="col-xl-7 col-lg-8 col-md-9 col-11 text-center">
                    ...
                    <div class="card">
                        ...
                        <h3>KPMG BA/BI Certification Course 3rd Attempt fee Payment</h3>
                        <p class="blue-text"><b>Enter Only Admission ID. We Will get your information from database.</b>
                        </p>
                        <form action="ccavRequestHandlerKpmg.php" name="OtherFeesPayment" id="OtherFeesPayment"
                            ...
                            <input type="hidden" name="redirect_url" id="redirect_url"
                                value="https://uat.mitsde.com/ccavResponseHandlerKpmg.php" />
                            ...
                            <div class="row justify-content-between text-left mt-2" >
                                ...
                                <input type="hidden" class="form-control" name="SpecializationID" readonly id="SpecializationID" value="<?php echo htmlspecialchars($SpecializationID, ENT_QUOTES, 'UTF-8'); ?>"  placeholder="Course Name">
                            ...
                            <div class="form-group mt-2">
                                    <div>
                                        <input type="text" readonly class="form-control" name="amount" value="1000" id="exampleInputPassword1" placeholder="Amount">
                                            <input type="hidden" readonly class="form-control" id="merchant_param2" name="merchant_param2" value="140" >
