...
<head>
    ...
    <!-- CANONICAL TAG -->
    <link rel="canonical" href="https://mitsde.com/Paid-Workshop" />
    <!-- CANONICAL TAG -->
                ...
                <div class="row d-flex justify-content-center">
                    <div class="col-xl-7 col-lg-8 col-md-9 col-11 text-center">
                        ...
                        <div class="card">
                            ...
                            <h3>Payment For <?php echo htmlspecialchars($pagename, ENT_QUOTES, 'UTF-8'); ?></h3>
                            <!-- <p class="blue-text"><b>Enter Only Admission ID. We Will get your information from database.</b> -->
                            </p>
                            <form action="paid-workshop-RequestHandler.php" name="PaidWorkshopFeesPayment"
                                ...
                                <div class="form-group">
                                    <div id="statediv">
                                        <input type="hidden" class="form-control" name="amount"
                                            ...
                                            value="<?php echo htmlspecialchars($workshop_amt, ENT_QUOTES, 'UTF-8'); ?>">
                                    </div>
                                </div>
