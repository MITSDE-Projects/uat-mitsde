<?php
$pagename = "Payment For Admission";
session_start();
...
<head>
    ...
    <title>Online Payment | Payment For Admission | MITSDE</title>
    ...
    "itemListElement": [
        ...
        { "@type": "ListItem", "position": 2, "name": "Payment For Admission", "item": "https://mitsde.com/new-admission-form-payment" }
    ]
    }
    </script>
...
<section class="hero ph-hero">
    ...
    <nav class="page-breadcrumb" aria-label="Breadcrumb">
        ...
        <span class="pb-current">Payment For Admission</span>
    </nav>

    <div class="container">
        <div class="ph-layout py-5">
            <div class="ph-left">
                <h1 class="ph-heading">Payment For <span class="text-orange">Admission</span></h1>
            </div>
            <div class="ph-right">
                <img src="assets-new/images/application-process.webp" alt="Payment For Admission" />
            </div>
        </div>
    </div>
...
<section class="rf-section">
    <div class="container">
        <div class="rf-card">
            <h2 class="rf-heading">Payment For Admission</h2>
            ...
            <form action="new-erp-RequestHandler.php" name="OtherFeesPayment" id="OtherFeesPayment"
                ...
                <div class="row justify-content-between text-start">
                    ...
                    <div class="form-group col-sm-6 d-flex flex-column mt-2">
                        <select class="form-select form-select-md" name="merchant_param1" id="merchant_param1"
                    ...
                    <div class="form-group col-sm-6 d-flex flex-column mt-2">
                        <select class="form-select form-select-md" name="SpecializationID" id="SpecializationID">
                    ...
                    <div class="form-group col-sm-6 d-flex flex-column mt-2">
                        <select class="form-select form-select-md" name="merchant_param4" id="merchant_param4">
...
<section class="about-section">
    <div class="container">
        <h3 class="fw-bold mb-4">Our RBI Registered NBFC Partners</h3>
        <div class="tbl-wrap">
            <table class="tbl">
                <thead>
                    <tr>
                        <th class="tbl-label">S.No</th>
                        <th class="tbl-label">NBFC Name</th>
                        <th class="tbl-label">Official Website</th>
                    </tr>
                </thead>
                <tbody>
                    <tr>
                        <td>1</td>
                        <td>FIBE</td>
                        <td><a href="https://www.fibe.in/" target="_blank">https://www.fibe.in/</a></td>
                    </tr>
                    <tr>
                        <td>2</td>
                        <td>Propelld</td>
                        <td><a href="https://propelld.com/signin" target="_blank">https://propelld.com/signin</a></td>
                    </tr>
                    <tr>
                        <td>3</td>
                        <td>Grayquest</td>
                        <td><a href="https://customer.grayquest.com/" target="_blank">https://customer.grayquest.com/</a></td>
                    </tr>
                </tbody>
            </table>
        </div>
...
<script>
    function getSpecializations(courseValue) {
        ...
        // Split the value on the first underscore
