    ...
    <main class="main-body">
        ...
        <div class="container">
            <div class="row">
                ...
                if ($order_status === "Success") {
                    ...
                    if ($orchk > 0 || $trchk > 0) {
                        ...
                        if ($responseData) {
                            ...
                            if ($apiResult === true) {
                                //echo "</br>INSERT INTO `OtherFeesTransactionN` (`othr_id`, `leadID`, `name`, `email`, `phone`, `CourseName`,`SpecializationID`, `FeeHeadID`, `FeesType`, `ReceiptType`, `amount`, `PayU_ID`, `payment_source`, `PayerBankID`, `transationDate`, `t_process_id`, `UTRNO`, `payment_confirmation_status`, `PayeeInstituteID`, `PayeeBankID`, `PayeeACNo`, `PayeeACName`, `PayeeBranch`, `PayeeBankAddress`, `PayeeIFSCCode`, `S_Flag`, `response`, `F_Flag`,`harbouroffering`,`learnerstatus`, API_DT, `json_rs_payment`) VALUES (NULL, '".$LeadID[1]."', '".$temp1['student_name']."', '".$temp1['email_id']."','".$temp1['phone']."', '".$temp1['course']."','".$temp1['SpecializationID']."', '19', 'MIT Harbour','OC','".$dotamt[0]."','".$transationID[1]."', 'ICICI','1', '".$tdate."','".$oderID[1]."', NULL, 'Not Verify', '16', '1', '50100267576292', 'Pune', 'Mayur Colony Kothrud Pune name', 'Mayur Colony Kothrud Pune address', 'HDFC0000149', '0', '" . $paymentMessage . "', '1','".$temp1['fees_type']."','".$learnerstatus[1]."','" . $apidataTime . "','" . $postfeeData . "')";
                                $updateQuery = "INSERT INTO `OtherFeesTransactionN` (`othr_id`, `leadID`, `name`, `email`, `phone`, `CourseName`,`SpecializationID`, `FeeHeadID`, `FeesType`, `ReceiptType`, `amount`, `PayU_ID`, `payment_source`, `PayerBankID`, `transationDate`, `t_process_id`, `UTRNO`, `payment_confirmation_status`, `PayeeInstituteID`, `PayeeBankID`, `PayeeACNo`, `PayeeACName`, `PayeeBranch`, `PayeeBankAddress`, `PayeeIFSCCode`, `S_Flag`, `response`, `F_Flag`,`harbouroffering`,`learnerstatus`, API_DT, `json_rs_payment`) VALUES (NULL, '" . $LeadID[1] . "', '" . $temp1['student_name'] . "', '" . $temp1['email_id'] . "','" . $temp1['phone'] . "', '" . $temp1['course'] . "','" . $temp1['SpecializationID'] . "', '19', 'MIT Harbour','OC','" . $dotamt[0] . "','" . $transationID[1] . "', 'ICICI','1', '" . $tdate . "','" . $oderID[1] . "', NULL, 'Not Verify', '16', '1', '50100267576292', 'Pune', 'Mayur Colony Kothrud Pune name', 'Mayur Colony Kothrud Pune address', 'HDFC0000149', '1', '" . $paymentMessage . "', '1','" . $temp1['fees_type'] . "','" . $learnerstatus[1] . "','" . $apidataTime . "','" . $postfeeData . "')";
                                mysql_query($updateQuery) or die('</br>Error, insert query failed');

                            } else {
                                // echo "</br>INSERT INTO `OtherFeesTransactionN` (`othr_id`, `leadID`, `name`, `email`, `phone`, `CourseName`,`SpecializationID`, `FeeHeadID`, `FeesType`, `ReceiptType`, `amount`, `PayU_ID`, `payment_source`, `PayerBankID`, `transationDate`, `t_process_id`, `UTRNO`, `payment_confirmation_status`, `PayeeInstituteID`, `PayeeBankID`, `PayeeACNo`, `PayeeACName`, `PayeeBranch`, `PayeeBankAddress`, `PayeeIFSCCode`, `S_Flag`, `response`, `F_Flag`,`harbouroffering`,`learnerstatus`, API_DT, `json_rs_payment`) VALUES (NULL, '".$LeadID[1]."', '".$temp1['student_name']."', '".$temp1['email_id']."','".$temp1['phone']."', '".$temp1['course']."','".$temp1['SpecializationID']."', '19', 'MIT Harbour','OC','".$dotamt[0]."','".$transationID[1]."', 'ICICI','1', '".$tdate."','".$oderID[1]."', NULL, 'Not Verify', '16', '1', '50100267576292', 'Pune', 'Mayur Colony Kothrud Pune name', 'Mayur Colony Kothrud Pune address', 'HDFC0000149', '0', '" . $paymentMessage . "', '2','".$temp1['fees_type']."','".$learnerstatus[1]."','" . $apidataTime . "','" . $postfeeData . "')";
                                $updateQuery = "INSERT INTO `OtherFeesTransactionN` (`othr_id`, `leadID`, `name`, `email`, `phone`, `CourseName`,`SpecializationID`, `FeeHeadID`, `FeesType`, `ReceiptType`, `amount`, `PayU_ID`, `payment_source`, `PayerBankID`, `transationDate`, `t_process_id`, `UTRNO`, `payment_confirmation_status`, `PayeeInstituteID`, `PayeeBankID`, `PayeeACNo`, `PayeeACName`, `PayeeBranch`, `PayeeBankAddress`, `PayeeIFSCCode`, `S_Flag`, `response`, `F_Flag`,`harbouroffering`,`learnerstatus`, API_DT, `json_rs_payment`) VALUES (NULL, '" . $LeadID[1] . "', '" . $temp1['student_name'] . "', '" . $temp1['email_id'] . "','" . $temp1['phone'] . "', '" . $temp1['course'] . "','" . $temp1['SpecializationID'] . "', '19', 'MIT Harbour','OC','" . $dotamt[0] . "','" . $transationID[1] . "', 'ICICI','1', '" . $tdate . "','" . $oderID[1] . "', NULL, 'Not Verify', '16', '1', '50100267576292', 'Pune', 'Mayur Colony Kothrud Pune name', 'Mayur Colony Kothrud Pune address', 'HDFC0000149', '0', '" . $paymentMessage . "', '2','" . $temp1['fees_type'] . "','" . $learnerstatus[1] . "','" . $apidataTime . "','" . $postfeeData . "')";
                                mysql_query($updateQuery) or die('</br>Error, insert query failed');
                        ...
                        //             //echo "</br>INSERT INTO `OtherFeesTransaction` (`othr_id`, `leadID`, `name`, `email`, `phone`, `CourseName`,`SpecializationID`, `FeeHeadID`, `FeesType`, `ReceiptType`, `amount`, `PayU_ID`, `payment_source`, `PayerBankID`, `transationDate`, `t_process_id`, `UTRNO`, `payment_confirmation_status`, `PayeeInstituteID`, `PayeeBankID`, `PayeeACNo`, `PayeeACName`, `PayeeBranch`, `PayeeBankAddress`, `PayeeIFSCCode`, `S_Flag`, `response`, `F_Flag`,`harbouroffering`,`learnerstatus`, API_DT, `json_rs_payment`) VALUES (NULL, '".$LeadID[1]."', '".$temp1['student_name']."', '".$temp1['email_id']."','".$temp1['phone']."', '".$temp1['course']."','".$temp1['SpecializationID']."', '136', 'MIT Harbour','".$ReceiptType."','".$dotamt[0]."','".$transationID[1]."', 'ICICI','1', '".$tdate."','".$oderID[1]."', NULL, 'Not Verify', '16', '1', '50100267576292', 'Pune', 'Mayur Colony Kothrud Pune name', 'Mayur Colony Kothrud Pune address', 'HDFC0000149', '0', NULL, '1','".$temp1['fees_type']."','".$learnerstatus[1]."','" . $apidataTime . "','" . $postfeeData . "')";
                        // 	   $insertO_tras= "INSERT INTO `OtherFeesTransactionN` (`othr_id`, `leadID`, `name`, `email`, `phone`, `CourseName`,`SpecializationID`, `FeeHeadID`, `FeesType`, `ReceiptType`, `amount`, `PayU_ID`, `payment_source`, `PayerBankID`, `transationDate`, `t_process_id`, `UTRNO`, `payment_confirmation_status`, `PayeeInstituteID`, `PayeeBankID`, `PayeeACNo`, `PayeeACName`, `PayeeBranch`, `PayeeBankAddress`, `PayeeIFSCCode`, `S_Flag`, `response`, `F_Flag`,`harbouroffering`,`learnerstatus`, API_DT, `json_rs_payment`) VALUES (NULL, '".$LeadID[1]."', '".$temp1['student_name']."', '".$temp1['email_id']."','".$temp1['phone']."', '".$temp1['course']."','".$temp1['SpecializationID']."', '19', 'MIT Harbour','OC','".$dotamt[0]."','".$transationID[1]."', 'ICICI','1', '".$tdate."','".$oderID[1]."', NULL, 'Not Verify', '16', '1', '50100267576292', 'Pune', 'Mayur Colony Kothrud Pune name', 'Mayur Colony Kothrud Pune address', 'HDFC0000149', '0', NULL, '1','".$temp1['fees_type']."','".$learnerstatus[1]."','" . $apidataTime . "','" . $postfeeData . "')";
                ...
                $emailquery = mysql_query("INSERT INTO email_tracker (id, emailid, pagename, email_status, data_time) VALUES (NULL, '" . $StudentEmailID[1] . "', 'mit-office-of-career-services-registration', 'success', '" . $DT . "')");
                ...
                $mail->Send();
                //------------------------------Aborted Mail END----------------------------------------
                $emailquery = mysql_query("INSERT INTO email_tracker (id, emailid, pagename, email_status, data_time) VALUES (NULL, '" . $StudentEmailID[1] . "', 'mit-office-of-career-services-registration', 'abort', '" . $DT . "')");
                //---------------------------------------FOR DELETE FORM TEMP TABLE----------------------
                $deletetemp = mysql_query("DELETE FROM `temp` WHERE T_LeadID='" . $LeadID[1] . "' and tranID='" . $oderID[1] . "'");
                    //---------------------------------------FOR DELETE FORM TEMP TABLE------END----------------
                ...
                $mail->Send();
                //------------------------------Failure Mail END----------------------------------------
                $emailquery = mysql_query("INSERT INTO email_tracker (id, emailid, pagename, email_status, data_time) VALUES (NULL, '" . $StudentEmailID[1] . "', 'mit-office-of-career-services-registration', 'failure', '" . $DT . "')");
                //---------------------------------------FOR DELETE FORM TEMP TABLE----------------------
