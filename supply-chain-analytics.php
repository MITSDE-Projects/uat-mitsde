...
<body>
    ...
    <main class="main-body">
        ...
        <section id="supply-chain-analytics" class="enroll-certification">
            <div class="container">
                <div class="row">
                    <div class="col-md-12 col-lg-12 fintech-certi">
                        <h2><strong>What is Supply Chain Analytics?</strong></h2>
                    </div>

                    <div class="col-md-12 col-lg-12 fin-feature hero11">

                        <p>
                            <strong>Most students hear supply chain analytics only when they start reading management notes or attend classes,</strong> but the real meaning becomes clearer when we see how goods move across India. Every product you buy goes through a chain of suppliers, transporters, warehouses, shops and finally reaches your hands. When this chain works smoothly, the customer feels happy. When it breaks, the business feels pressure.
                        </p>
                        ...
                        <h3><strong>How Does Supply Chain Analytics Work?</strong></h3>
                        ...
                        <table class="table table-bordered">
                            <thead>
                                <tr>
                                    ...
                                    <th><strong>Simple Meaning</strong></th>
                                    <th><strong>Use for Students</strong></th>
                                </tr>
                            </thead>
                            <tbody>
                                <tr>
                                    <td><strong>Descriptive</strong></td>
                                    <td>Shows past performance</td>
                                    <td>Helps you see what went wrong</td>
                                </tr>
                                <tr>
                                    <td><strong>Predictive</strong></td>
                                    <td>Estimates future behaviour</td>
                                    <td>Helps planning for demand</td>
                                </tr>
                                <tr>
                                    <td><strong>Prescriptive</strong></td>
                                    <td>Suggests possible actions</td>
                                    <td>Helps decide better solutions</td>
                                </tr>
                            </tbody>
                        </table>
                        ...
                        <h3><strong>Importance of Supply Chain Analytics</strong></h3>
                        ...
                        <h3><strong>Why Choose Supply Chain Analytics?</strong></h3>
