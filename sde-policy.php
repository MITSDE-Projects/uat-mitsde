...
<section class="hero ph-hero">
    ...
    <nav class="page-breadcrumb" aria-label="Breadcrumb">
        ...
        <span class="pb-current">MITSDE Policy</span>
    </nav>

    <div class="container">
        <div class="ph-layout py-5">
            <div class="ph-left">
                <h1 class="ph-heading">MITSDE Policy</h1>
        ...
        <div class="container">
            ...
            <div class="tbl-wrap">
                <table class="tbl">
                    ...
                    <tbody>
                        <tr>
                            <td class="tbl-label">Privacy Policy:</td>
                            <td><a href="privacy-policy" style="text-decoration: none; color: #f47521;" target="_blank">Link</a></td>
                        </tr>

                        <tr>
                            <td class="tbl-label">Terms of Use:</td>
                            <td><a href="terms-use" style="text-decoration: none; color: #f47521;" target="_blank">Link</a></td>
                        </tr>

                        <tr>
                            <td class="tbl-label">Scholarship Policy:</td>
                            <td><a href="scholarship-policy" style="text-decoration: none; color: #f47521;" target="_blank">Link</a></td>
                        </tr>
                        <tr>
                            <td class="tbl-label">Grace Markes Policy:</td>
                            <td><a href="grace_marks_policy" style="text-decoration: none; color: #f47521;" target="_blank">Link</a></td>
                        </tr>

                        <tr>
                            <td class="tbl-label">Drug free campus policy and committe:</td>
                            <td><a href="assets/images/media/ComitteeDocument/Drug-free-campus-policy-and-committe.pdf" style="text-decoration: none; color: #f47521;" target="_blank">Link</a></td>
                        </tr>
                    </tbody>
                </table>
            </div>
