...
error_reporting(0);
   ...
   //	$workingKey='FF2048EE9548EAE83BF4797292611691';		//testing
	...
	$dataSize=sizeof($decryptValues);
	 ...
	 $consellername=explode('=',$decryptValues[27]); // consellername id merchant_param5
     $consellername[1];
       ...
       if($order_status==="Success")
	{
	     //  echo "</br>select * from temp where T_LeadID='".$LeadID[1]."' and tranID='".$oderID[1]."'";
		   ...
		   $temp = mysql_query("select * from temp where T_LeadID='".$LeadID[1]."' and tranID='".$oderID[1]."'");
		      ...
		      $temp1['T_B_Amount'];
		   //   die;
		   // echo "</br>select PayU_ID,t_process_id,amount from old_student_transaction where leadID='".$LeadID[1]."'";
		
		/*  $transation = mysql_query("select PayU_ID,t_process_id,amount from old_student_transaction where `leadID`='".$LeadID[1]."'");
			...
			$trchk = mysql_num_rows(mysql_query("select * from New_student_admission_transaction where `PayU_ID`='".$transationID[1]."'"));
			$orchk = mysql_num_rows(mysql_query("select * from New_student_admission_transaction where `t_process_id`='".$oderID[1]."'"));
		  ...
		  elseif($temp1['tranID'] !=$oderID[1] || $temp1['T_B_Amount'] != $dotamt[0] )
		     ...
		     echo "<br><h3>Thank You for Payment.</h3>.";
		            $tdate= date("Y/m/d");
	                 ...
	                 // echo "</br>INSERT INTO `old_student_transaction` (`othr_id`, `leadID`, `name`, `email`, `phone`, `CourseName`,`SpecializationID`, `FeeHeadID`, `FeesType`, `ReceiptType`, `amount`, `PayU_ID`, `payment_source`, `PayerBankID`, `transationDate`, `t_process_id`, `UTRNO`, `payment_confirmation_status`, `PayeeInstituteID`, `PayeeBankID`, `PayeeACNo`, `PayeeACName`, `PayeeBranch`, `PayeeBankAddress`, `PayeeIFSCCode`, `S_Flag`, `response`, `F_Flag`) VALUES (NULL, '".$LeadID[1]."', '".$temp1['student_name']."', '".$temp1['email_id']."','".$temp1['phone']."', '".$temp1['course']."', '".$temp1['SpecializationID']."', '".$feeheadid."', '".$temp1['fees_type']."','".$ReceiptType."','".$dotamt[0]."','".$transationID[1]."', 'HDFC', '1','".$tdate."','".$oderID[1]."', NULL, 'Not Verify', '16', '1', '50100267576292', 'Pune', 'Mayur Colony Kothrud Pune name', 'Mayur Colony Kothrud Pune address', 'HDFC0000149', '0', NULL, '1')";
				   $insertO_tras= "INSERT INTO `New_student_admission_transaction` (`othr_id`, `leadID`, `name`, `email`, `phone`, `CourseName`,`SpecializationID`, `FeeHeadID`, `FeesType`, `ReceiptType`, `amount`, `PayU_ID`, `payment_source`, `PayerBankID`, `transationDate`, `t_process_id`, `UTRNO`, `payment_confirmation_status`, `PayeeInstituteID`, `PayeeBankID`, `PayeeACNo`, `PayeeACName`, `PayeeBranch`, `PayeeBankAddress`, `PayeeIFSCCode`, `S_Flag`, `response`, `F_Flag`,`counseller_email`,`DT`) VALUES (NULL, '".$LeadID[1]."', '".$temp1['student_name']."', '".$temp1['email_id']."','".$temp1['phone']."', '".$temp1['course']."','".$Specialization[1]."', '".$feeheadid."', '".$temp1['fees_type']."','".$ReceiptType."','".$dotamt[0]."','".$transationID[1]."', 'HDFC','1', '".$tdate."','".$oderID[1]."', NULL, 'Not Verify', '16', '1', '50100267576292', 'Pune', 'Mayur Colony Kothrud Pune name', 'Mayur Colony Kothrud Pune address', 'HDFC0000149', '0', NULL, '1','".$consellername[1]."','".$DT."')";
			 ...
			 //$insertO_tras= "INSERT INTO `updpayment` (`id`, `LeadID`, `ReceiptType`, `PaymentType`, `PaymentModeID`, `InstruNo`, `InstruDate`, `ClearedDate`, `PaidAmount`, `FeeHeadID`, `PayerBankID`, `PayerBranch`, `PayerBankAddress`, `PayerIFSCcode`, `PayeeInstituteID`, `PayeeBankID`, `PayeeACNo`, `PayeeACName`, `PayeeBranch`,`PayeeBankAddress`, `PayeeIFSCCode`, `UserId`, `CurrencyID`) VALUES (NULL, '".$LeadID[1]."', 'OC', 'L','10', '".$transationID[1]."', '".$curdate."', '".$curdate."', '".".$dotamt[0]."."', '59', '10', NULL, NULL, NULL, '16', '1', '50100267576292', 'Pune','Mayur Colony Kothrud Pune name', 'Mayur Colony Kothrud Pune address', 'HDFC0000149', '8', '1')";
		           ...
		           echo "<table cellspacing=4 cellpadding=4>";
		            ...
		            echo '<tr><td>Selected Prgram :</td><td>'.$Studentcours[1].'</td></tr>';
		       ...
		       $mail  = new PHPMailer();
				 ...
				 <p>Hello <?php echo $StudentName[1]; ?></p>
                  ...
                  <p>Thank you for making your payment. It will take two working days to credit your payment into our system.</p>  </br>
					...
					<p>Selected Program Name : <?php echo $Studentcours[1]; ?> </p>
					<p>Selected Specialization Name : <?php echo $Specialization[1] ?> </p>
					<p>Fees Type : New Admission </p>
					<p>If you have any questions, please contact us at <?php echo $consellername[1]; ?> </p>
				<p>Thank you and see you soon.<br>
				 ...
				 <?php
		          /* $body  = ob_get_clean();
						...
						$mail->Subject    = "Admission Progressed - Complete Remaining Steps";
						...
						$counselleremail = $consellername[1];
