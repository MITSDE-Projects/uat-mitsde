            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-12 col-lg-6 main-banner">
                        <h1>Top Online Professional Certification In Project Management</h1>
                        <p>Master the art of project management with our certification program, ensuring success in
                            every endeavor</p>
                        <div class="page-btn">
                                            ...
                                            <ul class="curriculum">
                                                <table class="table">
                                                    ...
                                                    <tbody>
                                                        ...
                                                        <tr>
                                                            <td>3</td>
                                                            <td>Project Execution, Control and Closure
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td>4</td>
                                                            <td>Project Analysis and Integration Management
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td>5</td>
                                                            <td>Essentials of Agile Project Management
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td>6</td>
                                                            <td>MS Project and Jira</td>
                                                        </tr>
                                                    </tbody>
                                                </table>
                                            </ul>
