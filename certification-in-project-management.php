...
<head>
    ...
    <title>Certification in Project Management Course – MITSDE India</title>
  ...
  <?php include "5-common-seo-tag-2.php" ?>
    ...
    <section class="hero ph-hero">
        <nav class="page-breadcrumb" aria-label="Breadcrumb">
            ...
            <a href="#">PCP</a>
            <span class="pb-sep">/</span>
            <span class="pb-current">Certification in Project Management</span>
        </nav>
        <div class="container">
            ...
            <div class="ph-layout">
                ...
                <!-- Left — heading -->
                <div class="ph-left">
                    <h1 class="ph-heading">Top Online Professional<br> Certification In<br> Project Management</h1>
                </div>
            ...
            <div class="ph-specs-wrap">
                <div class="ph-specs">
                    ...
                    <a href="certification-in-project-management"><button class="ph-spec-pill is-active">Project Management</button></a>
    ...
    <section class="about-section pb-0" id="about">
        ...
        <div class="container">
            ...
            <p>
                This 6-month self-paced program helps you understand the basics of project management in a simple and easy way. You will learn how projects are planned, managed, and completed, along with concepts like teamwork, time management, and problem-solving. With real-life examples and practical learning, the course builds your confidence and gives you a strong foundation to explore careers in project management.
            </p>
                ...
                <div class="learning-outcomes-right">
                    <ul class="learning-outcomes-list">
                        ...
                        <li>
                            ...
                            <span>Understand project lifecycle, planning, execution, and closure</span>
                        </li>
                        <li>
                            <i class="fa-regular fa-square-check"></i>
                            <span>Learn risk management and stakeholder handling</span>
                        </li>
                        <li>
                            <i class="fa-regular fa-square-check"></i>
                            <span>Apply project management tools and techniques</span>
                        </li>
                    </ul>
                </div>
                        ...
                        <div class="pgcs-top">
                            <div class="pgcs-left">
                                ...
                                <ul class="pgcs-course-list">
                                    ...
                                    <li>Project Execution, Control and Closure</li>
                                    <li>Project Analysis and Integration Management</li>
                                    <li>Essentials of Agile Project Management</li>
                                    <li>MS Project and Jira</li>
                                </ul>
                            </div>
                        </div><!-- /pgcs-top -->
                    </div>
                    ...
                    <div class="faq-list">
                        ...
                        <div class="faq-item is-open">
                            ...
                            <div class="faq-a" style="background: transparent;">
                                <p class="text-dark">Completing a certification course in project management can open up a wide range of career opportunities across various industries, such as:</p>
                                <ul class="ac-list text-dark">
    ...
    <section class="sam-certificate-section" id="certificate">
        <div class="container">
            ...
            <div class="cert-img">
                <img class="img-fluid" src="assets-new/images/certificate/certification-in-project-management_cer.webp" alt="Certificate in Project Management" loading="lazy">
            </div>
        </div>
    </section>
