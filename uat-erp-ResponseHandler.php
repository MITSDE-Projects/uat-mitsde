                ...
                <div class="container">
                    <div class="row">
                        ...
                        if ($order_status === "Success") {
                            ...
                            // echo "</br>T_LeadID--->" . $temp1['T_LeadID'];
                            // echo "</br>tranID--->" . $temp1['tranID']; // order id
                            // echo "</br>student_name--->" . $temp1['student_name'];
                            // echo "</br>email_id--->" . $temp1['email_id'];
                            // echo "</br>phone--->" . $temp1['phone'];
                            // echo "</br>course--->" . $temp1['course'];
                            // echo "</br>SpecializationID--->" . $temp1['SpecializationID'];
                            // echo "</br>password--->" . $temp1['password'];
                            // echo "</br>fees_type--->" . $temp1['fees_type'];
                            // echo "</br>T_B_Amount--->" . $temp1['T_B_Amount'];
                            // echo "</br>orderID--->" . $orderID[1];
                            // echo "</br>dotamt--->" . $dotamt[0];
                            // echo "</br>old_counselorName--->" . $temp1['old_counselorName'];
                            // echo "</br>new_counselorName--->" . $temp1['new_counselorName'];
                            // echo "</br>flag--->" . $temp1['flag'];
                            ...
                            echo "</br>teamp_course-->" . $temp1['course'];
                            $courseinfo = explode('_', $temp1['course']);
                            $course_id = $courseinfo[0]; //course id
                            echo "</br>teampSpecializationID-->" . $temp1['SpecializationID'];
                            echo "</br>select UatNewCourseERP.CourseName, UatNewCourseERP.duration, UatNewERPSpecialization.SpecializationName from UatNewCourseERP,UatNewERPSpecialization where UatNewCourseERP.CourseID ='" . $course_id . "' AND UatNewERPSpecialization.CourseID ='" . $course_id . "' AND UatNewERPSpecialization.SpecializationID ='" . $temp1['SpecializationID'] . "'";
                            $coursequery = mysql_query("select UatNewCourseERP.CourseName, UatNewCourseERP.duration, UatNewERPSpecialization.SpecializationName from UatNewCourseERP,UatNewERPSpecialization where UatNewCourseERP.CourseID ='" . $course_id . "' AND UatNewERPSpecialization.CourseID ='" . $course_id . "' AND UatNewERPSpecialization.SpecializationID ='" . $temp1['SpecializationID'] . "'");
                            $scourse = mysql_fetch_array($coursequery);

                            echo "</br>cousername-->" . $course_Name = $scourse['CourseName'];
                            echo "</br>SpecializationName-->" . $Specialization_Name = $scourse['SpecializationName'];
                            echo "</br>duration-->" . $duration = $scourse['duration'];
                            ...
                            curl_setopt_array($curl, array(
                                ...
                                CURLOPT_HTTPHEADER => array(
                                    'Authorization: bearer kJbQ3mJtQKlwgL0GxZq9LO7Iaz2m-se_FRLiuSQTXkISX9pfObAteBfcJ4FXBsZd7qWr8z0I1gBCTJppUiGxDq2MB67elTYFWda8DqdSNBoCGrNM2VIRzLQNp8kWH7k7cy-I5nkofz6Uk4vedK6OhdjtTeX8CFhfsOsD0rzIWKfCHrkHE9tgIjIgrMD5wo3TaPY35osC4-iscIGd0nJTf63xTOnfLQD-XVTvxlHNBxxjvqOjfv7anK-11iQygYK8fyCyt-gjz-ButDKMHdPv6Ky1Af02JZjaiIOeeZpmviV3UkjwNhzbY5LOx1wjjNEKCWayAIUH_HUPNKjSoYGTN0XYp_S4iV7dkp7eDq80cbUXdZAYkJbwghrvr1Xi_ZmnXfw96HC501poKzNbmNUE7b8JYj9fGs3-UIvnaCoUqm9M5Oiij4K7-8LYSGHzdsqfqrkKiGMKG-eh8RExI9Q8zuP_kP-URB1MfcE8CL-zT6Z_JBlFCRDPBb9Ao7KsiGuK',
                            ...
                            // //print_r($response);
                            // //echo "</br>result_msg----->" . $response['ResultMessage'];
                            ...
                            $trchk = mysql_num_rows(mysql_query("select * from uat_erp_transaction where `PayU_ID`='" . $transationID[1] . "'"));
                            $orchk = mysql_num_rows(mysql_query("select * from uat_erp_transaction where `t_process_id`='" . $orderID[1] . "'"));
                            ...
                            if ($orchk > 0 || $trchk > 0) {
                                ...
                                if ($responseData) {
                                    ...
                                    if ($apiResult === true) {
                                        ...
                                        $updateQuery = "INSERT INTO `uat_erp_transaction` (`othr_id`, `leadID`, `name`, `email`, `phone`, `gender`, `CourseName`,`SpecializationID`,`dual_SpecializationID`,`password`, `FeeHeadID`, `FeesType`, `ReceiptType`, `amount`, `PayU_ID`, `payment_source`, `PayerBankID`, `transationDate`, `t_process_id`, `UTRNO`, `payment_confirmation_status`, `PayeeInstituteID`, `PayeeBankID`, `PayeeACNo`, `PayeeACName`, `PayeeBranch`, `PayeeBankAddress`, `PayeeIFSCCode`, `S_Flag`, `response`, `response2`, `F_Flag`,`API_DT`, `old_counselorName`, `new_counselorName`, `flag`,`counseller_email`,`DT`,`pay_request`,`lead_request`) VALUES (NULL, '" . $leadid . "', '" . $temp1['student_name'] . "', '" . $temp1['email_id'] . "','" . $temp1['phone'] . "','" . $temp1['gender'] . "', '" . $temp1['course'] . "','" . $temp1['SpecializationID'] . "','" . $temp1['dual_SpecializationID'] . "','" . $temp1['password'] . "', '" . $feeheadid . "', '" . $description . "','PRF','" . $dotamt[0] . "','" . $transationID[1] . "', 'HDFC','1', '" . $curdate . "','" . $orderID[1] . "', NULL, 'Not Verify', '16', '1', '50100267576292', 'Pune', 'Mayur Colony Kothrud Pune name', 'Mayur Colony Kothrud Pune address', 'HDFC0000149', '1', '" . $paymentMessage . "', '" . $leadMessage . "', '1','" . $apidataTime . "','" . $temp1['old_counselorName'] . "','" . $temp1['new_counselorName'] . "','1','" . $consellername[1] . "','" . $DT . "','" . $postfeeData . "','" . $postFields . "')";
                                        mysql_query($updateQuery) or die('</br>Error, insert query failed222');

                                    } else {

                                        $updateQuery = "INSERT INTO `uat_erp_transaction` (`othr_id`, `leadID`, `name`, `email`, `phone`, `gender`, `CourseName`,`SpecializationID`,`dual_SpecializationID`,`password`, `FeeHeadID`, `FeesType`, `ReceiptType`, `amount`, `PayU_ID`, `payment_source`, `PayerBankID`, `transationDate`, `t_process_id`, `UTRNO`, `payment_confirmation_status`, `PayeeInstituteID`, `PayeeBankID`, `PayeeACNo`, `PayeeACName`, `PayeeBranch`, `PayeeBankAddress`, `PayeeIFSCCode`, `S_Flag`, `response`, `response2`, `F_Flag`,`API_DT`, `old_counselorName`, `new_counselorName`, `flag`,`counseller_email`,`DT`,`pay_request`,`lead_request`) VALUES (NULL, '" . $leadid . "', '" . $temp1['student_name'] . "', '" . $temp1['email_id'] . "','" . $temp1['phone'] . "','" . $temp1['gender'] . "', '" . $temp1['course'] . "','" . $temp1['SpecializationID'] . "','" . $temp1['dual_SpecializationID'] . "','" . $temp1['password'] . "', '" . $feeheadid . "', '" . $description . "','PRF','" . $dotamt[0] . "','" . $transationID[1] . "', 'HDFC','1', '" . $curdate . "','" . $orderID[1] . "', NULL, 'Not Verify', '16', '1', '50100267576292', 'Pune', 'Mayur Colony Kothrud Pune name', 'Mayur Colony Kothrud Pune address', 'HDFC0000149', '0', '" . $paymentMessage . "', '" . $leadMessage . "', '0','" . $apidataTime . "','" . $temp1['old_counselorName'] . "','" . $temp1['new_counselorName'] . "','0','" . $consellername[1] . "','" . $DT . "','" . $postfeeData . "','" . $postFields . "')";
                                        mysql_query($updateQuery) or die('</br>Error, insert query failed222');
                                ...
                                echo '<tr><td>Fees Type :</td><td>' . $description . '</td></tr>';
                                ...
                                <table border="1">
                                    <tr>
                                        <td>
                                            <p>1) Course & Specialization-
                                                <b><?php echo $course_Name . " in " . $Specialization_Name . " " ?>
                                                    (<?php echo $duration; ?>)</b>
                                            </p>
