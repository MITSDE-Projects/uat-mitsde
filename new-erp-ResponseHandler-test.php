                ...
                <div class="container">
                    <div class="row">
                        ...
                        if ($order_status === "Success") {
                            ...
                            echo "</br>course_id" . $course_id = $courseinfo[0]; //course id
                        
                            // $course_id = mysql_real_escape_string($course_id); // Always sanitize input
                            echo "</br>specialization_id" . $specialization_id = isset($temp1['SpecializationID']) ? $temp1['SpecializationID'] : null;

                            if ($specialization_id == null || $specialization_id == '' || $specialization_id == 0) {
                                // SpecializationID is NULL or empty – use IS NULL in query
                                $coursequery = mysql_query("
                                    SELECT UatNewCourseERP.CourseName, UatNewCourseERP.duration, UatNewERPSpecialization.SpecializationName 
                                    FROM UatNewCourseERP, UatNewERPSpecialization 
                                    WHERE UatNewCourseERP.CourseID = '$course_id' 
                                    AND UatNewERPSpecialization.CourseID = '$course_id' 
                                    AND UatNewERPSpecialization.SpecializationID IS NULL
                                ");
                            } else {
                                // SpecializationID has a value – use = in query
                                $specialization_id = mysql_real_escape_string($specialization_id);
                                $coursequery = mysql_query("
                                    SELECT UatNewCourseERP.CourseName, UatNewCourseERP.duration, UatNewERPSpecialization.SpecializationName 
                                    FROM UatNewCourseERP, UatNewERPSpecialization 
                                    WHERE UatNewCourseERP.CourseID = '$course_id' 
                                    AND UatNewERPSpecialization.CourseID = '$course_id' 
                                    AND UatNewERPSpecialization.SpecializationID = '$specialization_id'
                                ");
                            }

                            echo "</br>scourse" . $scourse = mysql_fetch_array($coursequery);
                            echo "</br>course_Name" . $course_Name = $scourse['CourseName'];
                            echo "</br>Specialization_Name" . $Specialization_Name = $scourse['SpecializationName'];
                            $D_Specializationinfo = explode('_', $temp1['dual_SpecializationID']);
                            $D_Specialization_ID = $D_Specializationinfo[0]; //d_specialization id
                            $D_Specialization_Name = $D_Specializationinfo[1]; //d_specialization name
                        

                            if ($course_id == "10" and $specialization_id == "31")  // new EX program
                            {
                                $course_id = "46";
                            }
                            ...
                            if ($orchk > 0 || $trchk > 0) {
                                ...
                                if ($responseData) {
                                    ...
                                    if ($apiResult === true) {
                                        //echo "</br>INSERT INTO `New_erp_student_admission_transaction` (`othr_id`, `leadID`, `name`, `email`, `phone`, `gender`, `CourseName`,`SpecializationID`,`dual_SpecializationID`,`password`, `FeeHeadID`, `FeesType`, `ReceiptType`, `amount`, `PayU_ID`, `payment_source`, `PayerBankID`, `transationDate`, `t_process_id`, `UTRNO`, `payment_confirmation_status`, `PayeeInstituteID`, `PayeeBankID`, `PayeeACNo`, `PayeeACName`, `PayeeBranch`, `PayeeBankAddress`, `PayeeIFSCCode`, `S_Flag`, `response`, `response2`, `F_Flag`,`API_DT`, `old_counselorName`, `new_counselorName`, `flag`,`counseller_email`,`DT`,`json_rs_lead`,`json_rs_payment`) VALUES (NULL, '" . $leadid . "', '" . $temp1['student_name'] . "', '" . $temp1['email_id'] . "','" . $temp1['phone'] . "','" . $temp1['gender'] . "', '" . $temp1['course'] . "','" . $temp1['SpecializationID'] . "','" . $temp1['dual_SpecializationID'] . "','" . $temp1['password'] . "', '" . $feeheadid . "', '" . $description . "','PRF','" . $dotamt[0] . "','" . $transationID[1] . "', 'HDFC','1', '" . $curdate . "','" . $orderID[1] . "', NULL, 'Not Verify', '16', '1', '50100267576292', 'Pune', 'Mayur Colony Kothrud Pune name', 'Mayur Colony Kothrud Pune address', 'HDFC0000149', '1', '" . $paymentMessage . "', '" . $leadMessage . "', '1','" . $apidataTime . "','" . $temp1['old_counselorName'] . "','" . $temp1['new_counselorName'] . "','1','" . $consellername[1] . "','" . $DT . "','" . $postFields . "','" . $postfeeData . "')";
                                        $updateQuery = "INSERT INTO `New_erp_student_admission_transaction` (`othr_id`, `leadID`, `name`, `email`, `phone`, `gender`, `CourseName`,`SpecializationID`,`dual_SpecializationID`,`password`, `FeeHeadID`, `FeesType`, `ReceiptType`, `amount`, `PayU_ID`, `payment_source`, `PayerBankID`, `transationDate`, `t_process_id`, `UTRNO`, `payment_confirmation_status`, `PayeeInstituteID`, `PayeeBankID`, `PayeeACNo`, `PayeeACName`, `PayeeBranch`, `PayeeBankAddress`, `PayeeIFSCCode`, `S_Flag`, `response`, `response2`, `F_Flag`,`API_DT`, `old_counselorName`, `new_counselorName`, `flag`,`counseller_email`,`DT`,`json_rs_lead`,`json_rs_payment`) VALUES (NULL, '" . $leadid . "', '" . $temp1['student_name'] . "', '" . $temp1['email_id'] . "','" . $temp1['phone'] . "','" . $temp1['gender'] . "', '" . $temp1['course'] . "','" . $temp1['SpecializationID'] . "','" . $temp1['dual_SpecializationID'] . "','" . $temp1['password'] . "', '" . $feeheadid . "', '" . $description . "','PRF','" . $dotamt[0] . "','" . $transationID[1] . "', 'HDFC','1', '" . $curdate . "','" . $orderID[1] . "', NULL, 'Not Verify', '16', '1', '50100267576292', 'Pune', 'Mayur Colony Kothrud Pune name', 'Mayur Colony Kothrud Pune address', 'HDFC0000149', '1', '" . $paymentMessage . "', '" . $leadMessage . "', '1','" . $apidataTime . "','" . $temp1['old_counselorName'] . "','" . $temp1['new_counselorName'] . "','1','" . $consellername[1] . "','" . $DT . "','" . $postFields . "','" . $postfeeData . "')";
                                        mysql_query($updateQuery) or die('</br>Error, insert query failed True');

                                    } else {
                                        // echo "</br>INSERT INTO `New_erp_student_admission_transaction` (`othr_id`, `leadID`, `name`, `email`, `phone`, `gender`, `CourseName`,`SpecializationID`,`dual_SpecializationID`,`password`, `FeeHeadID`, `FeesType`, `ReceiptType`, `amount`, `PayU_ID`, `payment_source`, `PayerBankID`, `transationDate`, `t_process_id`, `UTRNO`, `payment_confirmation_status`, `PayeeInstituteID`, `PayeeBankID`, `PayeeACNo`, `PayeeACName`, `PayeeBranch`, `PayeeBankAddress`, `PayeeIFSCCode`, `S_Flag`, `response`, `response2`, `F_Flag`,`API_DT`, `old_counselorName`, `new_counselorName`, `flag`,`counseller_email`,`DT`,`json_rs_lead`,`json_rs_payment`) VALUES (NULL, '" . $leadid . "', '" . $temp1['student_name'] . "', '" . $temp1['email_id'] . "','" . $temp1['phone'] . "','" . $temp1['gender'] . "', '" . $temp1['course'] . "','" . $temp1['SpecializationID'] . "','" . $temp1['dual_SpecializationID'] . "','" . $temp1['password'] . "', '" . $feeheadid . "', '" . $description . "','PRF','" . $dotamt[0] . "','" . $transationID[1] . "', 'HDFC','1', '" . $curdate . "','" . $orderID[1] . "', NULL, 'Not Verify', '16', '1', '50100267576292', 'Pune', 'Mayur Colony Kothrud Pune name', 'Mayur Colony Kothrud Pune address', 'HDFC0000149', '0', '" . $paymentMessage . "', '" . $leadMessage . "', '0','" . $apidataTime . "','" . $temp1['old_counselorName'] . "','" . $temp1['new_counselorName'] . "','0','" . $consellername[1] . "','" . $DT . "','" . $postFields . "','" . $postfeeData . "')";
                                        $updateQuery = "INSERT INTO `New_erp_student_admission_transaction` (`othr_id`, `leadID`, `name`, `email`, `phone`, `gender`, `CourseName`,`SpecializationID`,`dual_SpecializationID`,`password`, `FeeHeadID`, `FeesType`, `ReceiptType`, `amount`, `PayU_ID`, `payment_source`, `PayerBankID`, `transationDate`, `t_process_id`, `UTRNO`, `payment_confirmation_status`, `PayeeInstituteID`, `PayeeBankID`, `PayeeACNo`, `PayeeACName`, `PayeeBranch`, `PayeeBankAddress`, `PayeeIFSCCode`, `S_Flag`, `response`, `response2`, `F_Flag`,`API_DT`, `old_counselorName`, `new_counselorName`, `flag`,`counseller_email`,`DT`,`json_rs_lead`,`json_rs_payment`) VALUES (NULL, '" . $leadid . "', '" . $temp1['student_name'] . "', '" . $temp1['email_id'] . "','" . $temp1['phone'] . "','" . $temp1['gender'] . "', '" . $temp1['course'] . "','" . $temp1['SpecializationID'] . "','" . $temp1['dual_SpecializationID'] . "','" . $temp1['password'] . "', '" . $feeheadid . "', '" . $description . "','PRF','" . $dotamt[0] . "','" . $transationID[1] . "', 'HDFC','1', '" . $curdate . "','" . $orderID[1] . "', NULL, 'Not Verify', '16', '1', '50100267576292', 'Pune', 'Mayur Colony Kothrud Pune name', 'Mayur Colony Kothrud Pune address', 'HDFC0000149', '0', '" . $paymentMessage . "', '" . $leadMessage . "', '0','" . $apidataTime . "','" . $temp1['old_counselorName'] . "','" . $temp1['new_counselorName'] . "','0','" . $consellername[1] . "','" . $DT . "','" . $postFields . "','" . $postfeeData . "')";
