                    ...
                    <div class="row">
                        ...
                        if ($order_status === "Success") {
                            ...
                            if ($temp1['tranID'] != $orderID[1] || $temp1['T_B_Amount'] != $dotamt[0]) {
                                ...
                                $mail->Subject = "Generative AI for Educators Workshop Payment";
                                ...
                                // $mail->AddBCC('shilpi.paliwal@mitsde.com');
                                ...
                                $email_page = 'generative-ai-for-educators';
                                $email_stat = 'success';
                                $stmt->execute([
                                    $StudentEmailID[1],
                                    $email_page,
                                ...
                                $stmt = $conn->prepare("DELETE FROM temp_erp WHERE email_id = ? AND tranID = ?");
                                $stmt->execute([
                                    $StudentEmailID[1],
                                    $orderID[1]
                                ]);
                        ...
                        echo "</table><br>";
                        echo "<div class='mt-3'><a href='https://mitsde.com/generative-ai-for-educators/' class='btn btn-primary'>Go Back</a></div>";
                        echo "</center>";
                        ?>
                    </div>
                </div>
