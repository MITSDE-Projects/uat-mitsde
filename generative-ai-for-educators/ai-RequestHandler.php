...
$Role = trim($_POST['merchant_param2']);  //merchant_param2
...
(student_name, email_id, phone, course, password, fees_type, T_installmentNo, T_A_Amount, T_B_Amount, tranID, P_Start_date, Status, gateway_name, flag)
