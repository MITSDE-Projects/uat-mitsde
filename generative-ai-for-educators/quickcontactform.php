...
<form action="thankyou.php" method="post" class="reservation-form mt-20 myFormH" accept-charset="utf-8"
    ...
    <div class="form-check">
        ...
        <small class="text-dark">I authorize MIT-SDE representative to contact me, this will override
            DND/NDNC
            registry.</small>
    </div>
    ...
    <div class="form-group ">
        ...
        <button type="button" id="submitbtnsticky" class="btn btn-primary w-100 "
