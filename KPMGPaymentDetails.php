...
<title>KPMG Blacklog Payment Details</title>
<body>
    <div align="center"><h1>MITSDE - KPMG Blacklog Payment Details</h1></div>
<table id="example" class="display" style="width:100%">
        ...
        <tbody>
          <?php 
          $i=1;
          $serch=mysql_query("SELECT othr_id,name,email,phone,amount,PayU_ID,transationDate,leadID FROM `OtherFeesTransaction` WHERE `FeesType`='KPMG Backlog Fee' || `FeeHeadID`='141' ORDER BY `OtherFeesTransaction`.`othr_id` DESC");
