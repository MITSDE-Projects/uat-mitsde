                            ...
                            <div class="row justify-content-between text-left">
                                ...
                                <div class="form-group col-sm-6 flex-column d-flex mt-2">
                                    ...
                                    <select class="form-select form-select-md " aria-label="Small select example"
                                        ...
                                        <option value="7_Lumpsum">Lumpsum</option>
                                        <option value="1_Installment">Installment</option>
                                        <option value="35_NBFC">NBFC Part Payment</option>
                                ...
                                <div class="form-group col-sm-6 flex-column d-flex mt-2">
                                    <select class="form-select" data-live-search="true" name="merchant_param4"
                                        id="merchant_param4">
                                ...
                                <div class="center mt-2">
                                    <button type="submit" style="width: 50%;" class="btn btn-primary mit-button">Pay
                                        Now</button>
                                </div>
