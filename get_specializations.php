...
if (isset($_GET['CourseName'])) {
    ...
    $courseQuery = mysql_query("SELECT CourseID FROM CourseERP WHERE CourseName = '$CourseName'");
    ...
    if ($courseRow) {
        ...
        $query = mysql_query("SELECT * FROM SpecializationQuick WHERE CourseID = '$courseID'");
