...
<script language="javascript" type="text/javascript">
    function sendtoreject(value, id) {
        const url = 'Paid-Workshop-new.php?mitStud_amt=<?php echo $_SESSION["erpstud"]; ?>' +
...
<head>
    ...
    <!-- CANONICAL TAG -->
    <link rel="canonical" href="https://mitsde.com/Paid-Workshop-new" />
    <!-- CANONICAL TAG -->
                        ...
                        <form action="paid-workshop-RequestHandler.php" name="PaidWorkshopFeesPayment"
                            ...
                            <div class="w-50">
                                <input type="text" class="form-control" name="regid" id="regid"
                                    ...
                                    value="<?php echo htmlspecialchars($StudentID); ?>" placeholder="Admission ID"
                            ...
                            <div class="row">
                                <div class="form-group d-flex gap-2 mb-3">
                                    <input type="text" class="form-control" name="billing_email" id="EmailID"
                                        value="<?php echo htmlspecialchars($EmailID); ?>" placeholder="Email ID">

                                    <input type="text" class="form-control" name="delivery_tel" id="MobileNo"
                                        value="<?php echo htmlspecialchars($MobileNumber); ?>" placeholder="Mobile No">
                                </div>
                            </div>
