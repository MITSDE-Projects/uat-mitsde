    ...
    if( $_SERVER['REQUEST_METHOD'] == 'POST' )
	{
	        ...
	        if( $_POST['billing_email'] != '' AND $_POST['delivery_tel'] != '' AND $_POST['amount']!= '' ) 
	         ...
	         else
	           {
	              ...
	              echo "</br><a href='https://www.mitsde.com/educate/harbourPayment.php'>Go Back</a>";
	             die;  
	          }
	          }
	     else
...
//	die;
	...
	if($orchk>0)
		  ...
		  echo "<a href='https://www.mitsde.com/OtherFeesPaymentHDFC'>Go Back</a>";
		  die;
		  }
		  else
		  {
