...
$DualDegreeSp=$userdata['DualDegreeSp'];
$DualDegreeSpID=$userdata['DualDegreeSpID'];
...
$ExtraEdgeID =$userdata['ExtraEdgeID'];


$phonenumber=$userdata['phonenumber'];
$international_no=$userdata['international_no'];

$physicallychallenged=$userdata['physicallychallenged'];
$nationality=$userdata['nationality'];
$passport_no=$userdata['passport_no'];
$institute=$userdata['institute']; //category
$mpdomicile=$userdata['mpdomicile'];

$CcountryID=$userdata['CcountryID'];
$PcountryID=$userdata['PcountryID'];
$CcityID=$userdata['CcityID'];

$PcityID=$userdata['PcityID'];
$PstateID=$userdata['PstateID'];
$CstateID=$userdata['CstateID'];
