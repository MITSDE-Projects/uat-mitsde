       ...
       function getsetshowhide(val){
        ...
        if(val=='installment'){
         ...
         if(val=='NBFC') {
            ...
            document.getElementById('paymentoptionh').style.display='none';
          ...
          <span>G. Payment Details</span>
         	...
         	<div class="dp">Select Payment Option
                    <select name="paytype" required onChange="getsetshowhide(this.value);">
                        ...
                        <option value="NBFC">NBFC</options>
            ...
            <div  style="clear:both"></div>
          <div id="paymentoptionh" style="font-size:14px; margin-bottom:18px; color: #606062; font-weight:bold;">
           Please Select any Online payment gateway </div>
          
          
            
             <div id="paymentoption" class="dp">
