...
$A_Amt = $_POST['A_Amt'];
$B_Amt = $_POST['B_Amt'];
$student_name = $_POST['firstname']." ".$_POST['lastname'];
$Email= $_POST['email'];
...
$payuarr['surl'] = 'https://www.mitsde.com/apply/admission-response.php';
$payuarr['furl'] = 'https://www.mitsde.com/apply/admission-payuform.php';;
