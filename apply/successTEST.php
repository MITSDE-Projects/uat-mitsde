...
//echo $memberid; exit; 
 echo "</br>SELECT * FROM `student` WHERE `email` = '".$email."'";
       ...
       echo "</br>pay0-->".$memberID=$row['memberID'];
        echo "</br>pay1-->".$ERPLeadID=$row['ERPLeadID'];
        echo "</br>pay2-->".$Studentcours=$row['desciplines'];
        echo "</br>pay3-->".$s_ID=$row['SpecializationID']; 
       echo "</br>pay4-->". $phonenumber=$row['phonenumber'];
       echo "</br>pay5-->". $name=$row['name'];
       echo "</br>pay6-->". $lastname=$row['lastname'];
       echo "</br>pay7-->". $studentname=$row['name']." ".$row['lastname'];
