...
<a target="_blank" href="javascript:void(0);"><img src="https://www.mitsde.com/media/Logos/mitsde logo svg-01.svg" style="width:25%;height:25%"></a><p style="margin-top:-10px;  margin-bottom:15px;font-size:14px;font-family:'Roboto', sans-serif;"></p>
	...
	<form class="uploadform" method="post" enctype="multipart/form-data" action='uploaddocument.php?dir=<?php echo $docsdir;?>&memberID=<?=$_SESSION['memberID'];?>&id=<?php echo $aid;?>&n=<?php echo $name."_".$lastname;?>&ft=hsc'>
		...
		<form class="uploadform" method="post" enctype="multipart/form-data" action='uploaddocument.php?dir=<?php echo $docsdir;?>&memberID=<?=$_SESSION['memberID'];?>&id=<?php echo $aid;?>&n=<?php echo $name."_".$lastname;?>&ft=experience'>
			...
			<div class="file_upload">
                        ...
                        <? } ?>    
				<label class="fileuploadlabel">14. Experience Letter </label>
		...
		<form class="uploadform" method="post" enctype="multipart/form-data" action='uploaddocument.php?dir=<?php echo $docsdir;?>&memberID=<?=$_SESSION['memberID'];?>&id=<?php echo $aid;?>&n=<?php echo $name."_".$lastname;?>&ft=undertaking_form'>
			...
			<div class="file_upload">
                        ...
                        <? } ?>    
				<label class="fileuploadlabel">15. Undertaking Form</label>
