...
<option value="Financial Analytics" <? if($elective_b1=='Financial Analytics') { echo "SELECTED='SELECTED'"; }?>>Financial Analytics</option>
          ...
          <?php } ?> 
            ...
            <option value="Foreign National" <?php //if($nationalityselect=="Foreign National") echo "selected";?>>Foreign National</option>
				  ...
				  <input type="text" onkeypress="return isNumberKey(event);" id="aadhar" name="aadhar" value="<?php echo $aadhar;?>">
                          <span id="aadharerr"></span>
				  </div>
				  &nbsp;
				  <div class="dp" id="aadhardiv" style="display: inline;margin:-1px 0px 0px 10px">Name <span style="color:red">*</span> (As per aadhar card)<br />
				  <input type="text"  id="aadharName" name="aadharName" value="<?php echo $passport_no;?>" required>
 ...
 <!-- <div class="dp">Last Name<br />
   ...
   <div class="dp">Relationship with Applicant<br />
       	...
       	<input name="parentemail" type="email" id="parentemail" placeholder="Parents Email" value="<?php echo $parentemail;?>" style="margin-top:10px;width:90%;">   </div>
