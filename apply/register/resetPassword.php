...
if(isset($_POST['submit'])){
	...
	if(!isset($error)){
		...
		try {
			...
			$stmt = $db->prepare("UPDATE student SET password = :hashedpassword, resetComplete = 'Yes',active='Yes'   WHERE resetToken = :token");
			$stmt->execute(array(
			...
			header('Location: https://www.mitsde.com/apply/register/index.php?action=resetAccount');
			exit;
...
<table width="1000" border="0" align="center" cellpadding="0" cellspacing="0" >
  <tr>
	...
	<a href="https://www.mitsde.com/" target="_blank"><img src="https://www.mitsde.com/apply/images/logo-1.png" width=200 height=80 style="float:left;"/></a>
...
<div class="divider-text gap-top-20 gap-bottom-45">
	    	...
	    	<?php if(isset($stop)){
				...
				<form role="form" method="post" action="" autocomplete="off">
					...
					<hr>
					<div class="row">
						<div class="col-xs-6 col-md-6"><input type="submit" name="submit" value="Change Password"></div>
					</div>
				</form>
