...
?>        
                 ...
                 <?php
                   $body  = ob_get_clean();
                        ...
                        $mail->Subject = "MIT SDE: Registration 2022 / 23";
...
<div class="row">
		...
		<p style="margin-top:-10px;  margin-bottom:15px;font-size:14px;clear:both;font-family:'Roboto', sans-serif;">Approved by A I C T E, Govt.of India.</p></div>
           ...
           <div class="col-md-6" style="margin-top:10px;">
               <div class="col-md-3" > <a href="https://mitsde.com/" target="_blank"><h4>Contact Us</h4></a></div>
               <div class="col-md-3" ><h4>admission@mitsde.com</h4></div>
