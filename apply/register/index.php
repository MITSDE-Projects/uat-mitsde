<?php
//echo "Our website is currently experiencing downtime — we’re working to restore service as quickly as possible.";
//die;
// Redirect browser
header("Location: https://mitsde.com/new-admission-form-payment");
 exit;
ob_start();
