...
if(isset($_POST['submit'])){
	...
	if(!isset($error)){
		...
		try {
			...
			<p>If you did not request this change, please contact us immediately at admissions@mitsde.com.
			...
			// More headers
			$headers .= 'From: MIT SDE 2021 <admissions@mitsde.com>' . "\r\n";
			$headers .= 'To: <'.$to.'>' . "\r\n";
...
<table width="1000" border="0" align="center" cellpadding="0" cellspacing="0" >
    <tr>
        <td>
            <div class="wrapper-640">
        		...
        		<div class="">
        		<a href="https://www.mitsde.com/" target="_blank"><img src="https://www.mitsde.com/apply/images/logo-1.png" width=200 height=80 style="float:left; margin-left: 21px;"/></a><br/>
  ...
  <tr>
    ...
    <form role="form" method="post" action="" autocomplete="off">
				...
				<p><a href='https://mitsde.com/apply/register/index.php'>Back to login page</a></p>
							<?php
				...
				if(isset($_GET['action'])){
					...
					switch ($_GET['action']) {
						case 'active':
							...
							break;
						case 'reset':
							echo "<h3 class='bg-success'>Please check your inbox or Spam for a reset link.</h3>";
							break;
					}
				}
				?>
