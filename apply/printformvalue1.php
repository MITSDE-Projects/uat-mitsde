...
<a target="_blank" href="http://www.mitsde.com/"><img src="http://www.mitsde.com/apply/images/logo-1.png" style="width:200px;height:80px;float:left;padding-left: 8px;"></a><br/> 
   ...
   <div id="divToPrint" style="position:relative;top:45px;display:block;">
	...
	<div class="formheading"></div> 
     ...
     <div style="width:900px;font-size:15px;margin:auto;border:1px solid grey;text-align:justify;line-height:25px;">
        ...
        <?php if($programmesugpg=="MIT Skills")
                           {
                           ?>
                           <a target="_blank" href="https://mitskillsindia.edu.in"><img src="https://mitskillsindia.edu.in/assets/img/Skills-Logo.png" style="width:100px;height:80px;float:left;position:relative;left:20px;"></a><br/> 
	
    <h3 style="text-align:center;position: relative;top: -18px;">MIT Skills Application Form for Admission - <?php echo date('Y')?></h3>
    <div style="width:100%;margin-left:20px;"><b>Program</b>&nbsp;&nbsp;&nbsp;<?php echo $programmesugpg; ?></div>
<div style="width:100%;margin-left:20px;"><b>Course</b>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<?php echo $desciplines; ?>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</div>
   <?php
                           }
                           else{
                               ?>
                               <a target="_blank" href="http://www.mitsde.com/"><img src="http://www.mitsde.com/apply/images/logo-1.png" style="width:200px;height:80px;float:left;position:relative;left:20px;"></a><br/> 
...
<div style="width:100%;margin-left:20px;"><b>Course</b>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<?php echo $desciplines; ?>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</div>
   ...
   ?>
            ...
            <?php if($programmesugpg=="PGDM EMBA" || $programmesugpg=="PGDM (Executive) EMBA")
                           {
                           ?>
                          
                           <div style="width:100%;margin-left:20px;"><b>EMBA  Specialization</b>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<?php echo $DualDegreeSp ?>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                           </br><b>Elective Basket </b>&nbsp;</b></td><td><?php echo $elective_b1;?>
                           </div>
 ...
 <div style="width:900px;font-size:15px;margin:auto;border:1px solid grey;text-align:justify;height:150px;line-height:25px;">
			...
			<div style="float:left;width:100%">
				...
				<div style="float:left;width:25%"><?php echo $pcountry;?></div>
                 ...
                 <div style="width:900px;font-size:15px;margin:auto;border:1px solid grey;text-align:justify;height:225px;line-height:25px;">
			<div>
...
<div style="width:20%;float:left"><?php echo $scorepostgraduation;?></div>
	...
	<?php
if(isset($otherqualificationstatus))
{
	?>
	<div style="width:100%;float:left;margin-left:20px;">
<div style="width:20%;float:left;"><?php echo $otherqualification;?></div>

<div style="width:20%;float:left"><?php echo $examotherqualification; ?></div>
<div style="width:20%;float:left"><?php echo $yearofpassingotherqualification; ?></div>	
<div style="width:20%;float:left"><?php echo $scoreotherqualification;?></div>
</div>
	<?php } ?>
...
<li>Please note please check your course validity date on ID card, your course expires after the given date</li>
</ul>
</div>
        <br/><br/>
