...
smartech('contact', 'LIST IDENTIFIER', {
                   ...
                   smartech('identify', "<?php echo $email;?>");
                    ...
                    smartech('dispatch', 'Application Submitted', {
   ...
   <div id="divToPrint" style="position:relative;top:45px;display:block;">
	...
	<div class="formheading"></div> 
     ...
     <div style="width:900px;font-size:15px;margin:auto;border:1px solid grey;text-align:justify;line-height:25px;">
        ...
        <?php if($programmesugpg=="Career Aaccelerator Program (CAP)")
                           {
                               mysqli_query($connection,"UPDATE student SET CourseID='".$SpecializationID."' WHERE memberID='".$_SESSION['memberID']."'");
                           ?>
	...
	<p style="margin-top:-10px;position:relative;left:20px;margin-bottom:15px;font-size:14px;clear:both;font-family:'Roboto', sans-serif;">Approved by A I C T E, Govt.of India.</p>
                    ...
                    <div style="width:100%;margin-left:20px;"><b>Program</b>&nbsp;&nbsp;&nbsp;<?php echo $desciplines; ?>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<b>Application ID</b>&nbsp;&nbsp;<?=$userdata['applicationid']?></div>
