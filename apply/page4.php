...
{
 	header("location: https://mitsde.com/apply/register/index.php");//redirecting to second page
}
else
{
...
<a target="_blank" href="javascript:void(0);"><img src="https://www.mitsde.com/media/Logos/mitsde logo svg-01.svg" style=""></a><p style="margin-top:-10px;  margin-bottom:15px;font-size:14px;font-family:'Roboto', sans-serif;">Approved by A I C T E, Govt.of India.</p>
...
?>
	...
	<form class="uploadform" method="post" enctype="multipart/form-data" action='uploadphoto.php?dir=<?php echo $docsdir;?>&memberID=<?=$_SESSION['memberID'];?>&id=<?php echo $aid;?>&n=<?php echo $name."_".$lastname;?>&ft=photo'>
			...
			<div class="file_upload">
				...
				<label class="fileuploadlabel">Passport Size Photo <span style="color:red;">*</span></label>
                            ...
                            <span><img src="http://www.mitsde.com/apply/<?=$getstudmeatdata['photo']?>" style="height:50px;position:absolute;right:450px;"></span>
                            <? } else { ?>
	...
	<form class="uploadform" method="post" enctype="multipart/form-data" action='uploaddocument.php?dir=<?php echo $docsdir;?>&memberID=<?=$_SESSION['memberID'];?>&id=<?php echo $aid;?>&n=<?php echo $name."_".$lastname;?>&ft=ssc'>
		    <div class="custom_file_upload">
			<div class="file_upload">
			             <? if(isset($getstudmeatdata['ssc']) && $getstudmeatdata['ssc']!=""){ ?>
                             <span><img src="http://www.mitsde.com/apply/<?=$getstudmeatdata['ssc']?>" style="height:50px;position:absolute;right:450px;"></span> 
                         <?php } ?>         
	...
	<form class="uploadform" method="post" enctype="multipart/form-data" action='uploaddocument.php?dir=<?php echo $docsdir;?>&memberID=<?=$_SESSION['memberID'];?>&id=<?php echo $aid;?>&n=<?php echo $name."_".$lastname;?>&ft=hsc'>
		    <div class="custom_file_upload">
			<div class="file_upload">
			            <? if(isset($getstudmeatdata['hsc']) && $getstudmeatdata['hsc']!=""){ ?>
                          <span><img src="http://www.mitsde.com/apply/<?=$getstudmeatdata['hsc']?>" style="height:50px;position:absolute;right:450px;"></span>  
                        <?php } ?>   
        ...
        <form class="uploadform" method="post" enctype="multipart/form-data" action='uploaddocument.php?dir=<?php echo $docsdir;?>&memberID=<?=$_SESSION['memberID'];?>&id=<?php echo $aid;?>&n=<?php echo $name."_".$lastname;?>&ft=graduationcertificate_sem1'>
		    <div class="custom_file_upload">
			<div class="file_upload">
			            <? if(isset($getstudmeatdata['graduationcertificate_sem1']) && $getstudmeatdata['graduationcertificate_sem1']!=""){ ?>
                            <span><img src="https://www.mitsde.com/apply/<?=$getstudmeatdata['graduationcertificate_sem1']?>" style="height:50px;position:absolute;right:450px;"></span>
                        <? } ?>    
         ...
         <form class="uploadform" method="post" enctype="multipart/form-data" action='uploaddocument.php?dir=<?php echo $docsdir;?>&memberID=<?=$_SESSION['memberID'];?>&id=<?php echo $aid;?>&n=<?php echo $name."_".$lastname;?>&ft=graduationcertificate_sem2'>
		    <div class="custom_file_upload">
			<div class="file_upload">
			            <? if(isset($getstudmeatdata['graduationcertificate_sem2']) && $getstudmeatdata['graduationcertificate_sem2']!=""){ ?>
                            <span><img src="https://www.mitsde.com/apply/<?=$getstudmeatdata['graduationcertificate_sem2']?>" style="height:50px;position:absolute;right:450px;"></span>
                        <? } ?>    
         ...
         <form class="uploadform" method="post" enctype="multipart/form-data" action='uploaddocument.php?dir=<?php echo $docsdir;?>&memberID=<?=$_SESSION['memberID'];?>&id=<?php echo $aid;?>&n=<?php echo $name."_".$lastname;?>&ft=graduationcertificate_sem3'>
		    <div class="custom_file_upload">
			<div class="file_upload">
			            <? if(isset($getstudmeatdata['graduationcertificate_sem3']) && $getstudmeatdata['graduationcertificate_sem3']!=""){ ?>
                            <span><img src="https://www.mitsde.com/apply/<?=$getstudmeatdata['graduationcertificate_sem3']?>" style="height:50px;position:absolute;right:450px;"></span>
                        <? } ?>    
          ...
          <form class="uploadform" method="post" enctype="multipart/form-data" action='uploaddocument.php?dir=<?php echo $docsdir;?>&memberID=<?=$_SESSION['memberID'];?>&id=<?php echo $aid;?>&n=<?php echo $name."_".$lastname;?>&ft=graduationcertificate_sem4'>
		    <div class="custom_file_upload">
			<div class="file_upload">
         ...
         <form class="uploadform" method="post" enctype="multipart/form-data" action='uploaddocument.php?dir=<?php echo $docsdir;?>&memberID=<?=$_SESSION['memberID'];?>&id=<?php echo $aid;?>&n=<?php echo $name."_".$lastname;?>&ft=graduationcertificate_sem5'>
		    <div class="custom_file_upload">
			<div class="file_upload">
			            <? if(isset($getstudmeatdata['graduationcertificate_sem5']) && $getstudmeatdata['graduationcertificate_sem5']!=""){ ?>
                            <span><img src="https://www.mitsde.com/apply/<?=$getstudmeatdata['graduationcertificate_sem5']?>" style="height:50px;position:absolute;right:450px;"></span>
                        <? } ?>    
          ...
          <form class="uploadform" method="post" enctype="multipart/form-data" action='uploaddocument.php?dir=<?php echo $docsdir;?>&memberID=<?=$_SESSION['memberID'];?>&id=<?php echo $aid;?>&n=<?php echo $name."_".$lastname;?>&ft=graduationcertificate_sem6'>
		    <div class="custom_file_upload">
			<div class="file_upload">
			            <? if(isset($getstudmeatdata['graduationcertificate_sem6']) && $getstudmeatdata['graduationcertificate_sem6']!=""){ ?>
                            <span><img src="https://www.mitsde.com/apply/<?=$getstudmeatdata['graduationcertificate_sem6']?>" style="height:50px;position:absolute;right:450px;"></span>
                        <? } ?>    
           ...
           <form class="uploadform" method="post" enctype="multipart/form-data" action='uploaddocument.php?dir=<?php echo $docsdir;?>&memberID=<?=$_SESSION['memberID'];?>&id=<?php echo $aid;?>&n=<?php echo $name."_".$lastname;?>&ft=graduationcertificate_sem7'>
		    <div class="custom_file_upload">
			<div class="file_upload">
			            <? if(isset($getstudmeatdata['graduationcertificate_sem7']) && $getstudmeatdata['graduationcertificate_sem7']!=""){ ?>
                            <span><img src="https://www.mitsde.com/apply/<?=$getstudmeatdata['graduationcertificate_sem7']?>" style="height:50px;position:absolute;right:450px;"></span>
                        <? } ?>    
            ...
            <form class="uploadform" method="post" enctype="multipart/form-data" action='uploaddocument.php?dir=<?php echo $docsdir;?>&memberID=<?=$_SESSION['memberID'];?>&id=<?php echo $aid;?>&n=<?php echo $name."_".$lastname;?>&ft=graduationcertificate_sem8'>
		    <div class="custom_file_upload">
			<div class="file_upload">
			            <? if(isset($getstudmeatdata['graduationcertificate_sem8']) && $getstudmeatdata['graduationcertificate_sem8']!=""){ ?>
                            <span><img src="https://www.mitsde.com/apply/<?=$getstudmeatdata['graduationcertificate_sem8']?>" style="height:50px;position:absolute;right:450px;"></span>
                        <? } ?>    
     	...
     	<form class="uploadform" method="post" enctype="multipart/form-data" action='uploaddocument.php?dir=<?php echo $docsdir;?>&memberID=<?=$_SESSION['memberID'];?>&id=<?php echo $aid;?>&n=<?php echo $name."_".$lastname;?>&ft=graduationcertificate'>
		    <div class="custom_file_upload">
			<div class="file_upload">
			            <? if(isset($getstudmeatdata['graduationcertificate']) && $getstudmeatdata['graduationcertificate']!=""){ ?>
                            <span><img src="https://www.mitsde.com/apply/<?=$getstudmeatdata['graduationcertificate']?>" style="height:50px;position:absolute;right:450px;"></span>
                        <? } ?>    
		...
		<form class="uploadform" method="post" enctype="multipart/form-data" action='uploaddocument.php?dir=<?php echo $docsdir;?>&memberID=<?=$_SESSION['memberID'];?>&id=<?php echo $aid;?>&n=<?php echo $name."_".$lastname;?>&ft=identity'>
		    <div class="custom_file_upload">
			<div class="file_upload">
			            <? if(isset($getstudmeatdata['identity']) && $getstudmeatdata['identity']!=""){ ?>
                            <span><img src="https://www.mitsde.com/apply/<?=$getstudmeatdata['identity']?>" style="height:50px;position:absolute;right:450px;"></span> 
                        <? } ?>    
		...
		<form class="uploadform" method="post" enctype="multipart/form-data" action='uploaddocument.php?dir=<?php echo $docsdir;?>&memberID=<?=$_SESSION['memberID'];?>&id=<?php echo $aid;?>&n=<?php echo $name."_".$lastname;?>&ft=application_form'>
		    <div class="custom_file_upload">
			<div class="file_upload">
			            <? if(isset($getstudmeatdata['application_form']) && $getstudmeatdata['application_form']!=""){ ?>
                            <span><img src="https://www.mitsde.com/apply/<?=$getstudmeatdata['application_form']?>" style="height:50px;position:absolute;right:450px;"></span> 
                        <? } ?>    
		...
		<form class="uploadform" method="post" enctype="multipart/form-data" action='uploaddocument.php?dir=<?php echo $docsdir;?>&memberID=<?=$_SESSION['memberID'];?>&id=<?php echo $aid;?>&n=<?php echo $name."_".$lastname;?>&ft=undertaking_form'>
		    <div class="custom_file_upload">
			<div class="file_upload">
			            <? if(isset($getstudmeatdata['undertaking_form']) && $getstudmeatdata['undertaking_form']!=""){ ?>
                            <span><img src="https://www.mitsde.com/apply/<?=$getstudmeatdata['undertaking_form']?>" style="height:50px;position:absolute;right:450px;"></span> 
                        <? } ?>    
		...
		<form class="uploadform" method="post" enctype="multipart/form-data" action='uploaddocument.php?dir=<?php echo $docsdir;?>&memberID=<?=$_SESSION['memberID'];?>&id=<?php echo $aid;?>&n=<?php echo $name."_".$lastname;?>&ft=signature'>
		    <div class="custom_file_upload">
			<div class="file_upload">
		...
		<form class="uploadform" method="post" enctype="multipart/form-data" action='uploaddocument.php?dir=<?php echo $docsdir;?>&memberID=<?=$_SESSION['memberID'];?>&id=<?php echo $aid;?>&n=<?php echo $name."_".$lastname;?>&ft=experience'>
		    <div class="custom_file_upload">
			<div class="file_upload">
			            <? if(isset($getstudmeatdata['experience']) && $getstudmeatdata['experience']!=""){ ?>
                            <span><img src="https://www.mitsde.com/apply/<?=$getstudmeatdata['experience']?>" style="height:50px;position:absolute;right:450px;"></span> 
                        <? } ?>    
				<label class="fileuploadlabel">16. Experience Latter <span style="font-size:12px;color:red">*</span></label>
			    <input type="file" name="docfile" onchange="UploadFile('ExperinceLatter16');">
			</div>
		    </div>
		    <input type="submit" value="Submit" name="submiteventimg" id="ExperinceLatter16" style="display: none;">
		</form>
				 ...
				 <form action="page4_insertdata.php" method="post" onsubmit="return ValidateProfilePhoto();" style="background:#fff;height:100px;">
			...
			<!--<input  type="reset" value="Back" onclick="GotoPrevPage('page3_form.php');"/ style="background:#606062;color:#FFF;width:99px;font-size: 14px;padding: 5px 10px;">-->					
					...
					<input type="text" style="visibility: hidden;" id="photo" name="photo"/ style="background:#606062; color:#FFF;width:125px;">
				</div>
                 </form>
            </div>
