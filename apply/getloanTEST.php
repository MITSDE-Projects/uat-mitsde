...
Track your loan application <a href="https://loans.easebuzz.in/customers/track" target="_blank">here</a></p>
    ...
    <fieldset>
      <input  name="provider_short_code" type="text" value="<?php echo $_GET['provider_short_code']; ?>" readonly>
    </fieldset>
    <?php $uni_id=uniqid(); ?>
    ...
    <fieldset>
     ...
     <fieldset>
      <input type="text"  name="date_of_birth" value="<?php echo $_GET['date_of_birth']; ?>" readonly>
    </fieldset>
    <fieldset>
      <input type="text"  name="aadhar_number" value="<?php echo $_GET['aadhar_number']; ?>" readonly>
    </fieldset>
    <fieldset>
