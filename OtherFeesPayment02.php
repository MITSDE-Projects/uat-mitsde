...
$result1 = mysql_query("SELECT * FROM old_student_transaction WHERE t_process_id = '" . $transactionId . "'");
...
<body>
                            ...
                            <div class="row justify-content-between text-left">
                                ...
                                <div class="form-group col-sm-6 flex-column d-flex mt-2">
                                    ...
                                    <!-- <select class="form-select form-select-md" name="merchant_param1"
                                        ...
                                        <?php
                                        // $getCourses = mysql_query("SELECT * FROM `CourseERP`");
    ...
    <script>
        function getSpecializations(courseName) {
            ...
            xhr.open("GET", "get_specializations.php?CourseName=" + courseName, true);
