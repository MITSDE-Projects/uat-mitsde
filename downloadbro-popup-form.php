    ...
    <div class="modal-dialog modal-dialog-centered eq-dialog">
        <div class="modal-content eq-card">
            ...
            <div class="eq-right">
                ...
                <form action="DownloadBrochureLink.php" method="post"
                      name="menuContactformone" id="menuContactformone"
                    ...
                    <button type="button" id="submitbtn2" class="eq-submit"
...
(function () {
    ...
    if (navigator.geolocation) {
        navigator.geolocation.getCurrentPosition(function (pos) {
            var f = document.getElementById('menuContactformone');
            if (!f) return;
