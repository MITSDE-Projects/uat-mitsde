...
<head>
    ...
    <link rel="canonical" href="https://mitsde.com/OtherFeesPaymenticici" />
    ...
    <meta property="og:url" content="https://mitsde.com/OtherFeesPaymenticici">
                        ...
                        <form action="ccavRequestHandler0.php" name="OtherFeesPayment" id="OtherFeesPayment"
                            ...
                            <div class="row justify-content-between text-left mt-2" >
                                ...
                                <div class="center mt-2">
                                    <button type="submit" onclick="myfunction()" style="background: #f47521;width: 50%;color: #fff;" id="mysubmitBtn" disabled="disabled"
