...
<div class="col-md-12 offset-lg-1 d-flex justify-content-evenly col-lg-4" style="height:max-content;" id="firstform">
        <form action="thankyou.php" method="post" class="reservation-form mt-20 w-100" style="border-radius: 5px; background:#F47521;  padding: 10px"  accept-charset="utf-8"
            ...
            <div class="form-check">
                ...
                <small class="text-white" style="font-size: 8px;">I authorize MIT-SDE representative to contact me,this will override DND/NDNC
                    registry.</small>
            </div>

            <div class="form-group ">
                <input type="hidden" name="submitthirdcontact" value="submitthirdcontact" />
                <button type="button" id="submitbtnsticky" class="btn btn-light form-btn mit-footer btn-ripple w-100 "
