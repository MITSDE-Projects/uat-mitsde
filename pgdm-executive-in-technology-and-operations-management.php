            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-12 col-lg-6 main-banner">
                        <h1>PGDM Executive In Technology & Operations Management</h1>
                        <p>Make tech-ops your forte to capture the global market with your operational skills with <img src="assets/images/common-images/kpmg-png.png" style="width: 70px;" alt="KPMG logo"> in INDIA. ( Optional)</p>
                        <div class="page-btn">
                        ...
                        <div>
                            <nav>
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item active" aria-current="page">PGDM Executive Technology &
                    ...
                    <div class="col-md-12 col-lg-6">
                        <div class="css-details">
                            <div class="stc-det student-sec inner-sec">
                                <img src="assets/images/course/pgdm-exe/PGDM-Executive-Technology-&-Operations-Management_Icon2.jpg"
                                    alt="">
                            </div>
                            <img src="assets/images/course/pgdm-exe/PGDM-Executive-Technology-&-Operations-Management.jpg"
                                class="banner-img" fetchpriority="high" alt="PGDM-Executive-Technology-&-Operations-Management">
                            <div class="stc-det course-sec inner-sec">
                                <img src="assets/images/course/pgdm-exe/PGDM-Executive-Technology-&-Operations-Management_Icon1.jpg"
                                    alt="">
                            </div>
                        </div>
                    </div>
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-md-8 col-lg-8 fintech-certi fin-feature hero11">
                        <p>
                            The purview of <b>Operations Management ranges from strategic to tactical and
                                operational levels</b>.Operations Management deals with the design and
                            management of products, processes, services and supply chains. It deliberates the
                            procurement, development, and utilization of resources that companies need to
                            deliver the goods and services as per their clients’ needs.
                        </p>

                        <p>
                            The <b>Post Graduate Executive Diploma in Technology and Operations Management</b>
                            is designed to give learners the knowledge, skills and perspectives they need to
                            create value for their firms in the future. Designed to equip professionals with
                            competencies in the core disciplines of general management concepts along with an
                            in-depth understanding of the application of technology to achieve operational
                            excellence.
                        </p>
                    </div>
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-md-12 col-lg-8 fin-feature1 hero11">
                        ...
                        <li><span class="newright-icon1"></span> Understand the basics of operations management</li>
                        <li><span class="newright-icon1"></span> Learn the global best practises for operations
                            management</li>
                        <li><span class="newright-icon1"></span> Learn the analytical tools to derive accurate forecasts
                        </li>
                        <li><span class="newright-icon1"></span> Understand the application of technology in the supply
                            chain </li>
                        <li><span class="newright-icon1"></span> Learn risk management, people management and financial
                            analytics skills</li>
                        ...
                        <div class="accordion curriculum-accordion" id="freQuestions">
                            <div class="accordion-item">
                                ...
                                <div id="questions1" class="accordion-collapse collapse" data-bs-parent="#freQuestions">
                                    <div class="accordion-body hero10">
                                        <div class="row">
                                            <p>The course offers interesting career options for you
                                                namely:</p>
                                            <ul class="fin-feature2" style="list-style: none;">
                                                <li><span class="newright-icon1"></span> Supply Chain
                                                    Specialist/Manager/Analyst</li>
                                                <li><span class="newright-icon1"></span> Operations Team
                                                    Leader/Operations Manager/Operations Analyst</li>
                                                <li><span class="newright-icon1"></span> Procurement
                                                    Specialist/Buyer/Purchasing Manager</li>
                            ...
                            <div class="accordion-item">
                                ...
                                <h2 class="accordion-header">
                                    ...
                                    <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                                        ...
                                        What is the duration of the PGDM Executive in Technology & Operations Management
                                        program?
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-12 col-lg-12">
                                                ...
                                                <div class="fintech-module alert brandcolor">
                                                    ...
                                                    <p>The program covers the design and management of products,
                                                        processes, services, and supply chains, focusing on
                                                        the procurement, development, and utilization of
                                                        resources to meet client needs.</p>
                                            ...
                                            <div class="col-md-12 col-lg-12">
                                                ...
                                                <div class="fintech-module alert brandcolor">
                                                    ...
                                                    <p>Graduates can pursue leadership roles in various sectors,
                                                        including technology, manufacturing, supply chain management,
                                                        and operations.</p>
                            ...
                            <div class="accordion-item">
                                ...
                                <h2 class="accordion-header">
                                    ...
                                    <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                                        ...
                                        Is the program suitable for professionals from non-technical backgrounds?
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-12 col-lg-12">
                                                ...
                                                <div class="fintech-module alert brandcolor">
                                                    ...
                                                    <p>Yes, the program is designed to equip professionals
                                                        from diverse fields with the necessary skills in technology
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-12 col-lg-12">
                                                ...
                                                <div class="fintech-module alert brandcolor">
                                                    ...
                                                    <p>While a background in technology or operations is beneficial,
                            ...
                            <div class="accordion-item">
                                ...
                                <h2 class="accordion-header">
                                    ...
                                    <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                                        ...
                                        What makes this program unique compared to other technology and operations
                                        management courses?
                                            ...
                                            <div class="col-md-12 col-lg-12">
                                                ...
                                                <div class="fintech-module alert brandcolor">
                                                    ...
                                                    <p>The program offers a comprehensive curriculum tailored for middle
                                                        and senior executives, focusing on modern practices
