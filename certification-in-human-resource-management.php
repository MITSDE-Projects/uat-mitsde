  ...
  <?php include "5-common-seo-tag-2.php" ?>
    ...
    <section class="hero ph-hero">
        <nav class="page-breadcrumb" aria-label="Breadcrumb">
            ...
            <a href="#">PCP</a>
            <span class="pb-sep">/</span>
            <span class="pb-current">Certification in Human Resource Management</span>
        </nav>
        <div class="container">
            ...
            <div class="ph-layout">
                ...
                <!-- Left — heading -->
                <div class="ph-left">
                    <h1 class="ph-heading">Professional Certification<br> In Human Resource<br> Management</h1>
                </div>
            ...
            <div class="ph-specs-wrap">
                <div class="ph-specs">
                    ...
                    <a href="certification-in-human-resource-management"><button class="ph-spec-pill is-active">Human Resource Management</button></a>
                ...
                <div class="learning-outcomes-right">
                    <ul class="learning-outcomes-list">
                        ...
                        <li>
                            ...
                            <span>Understand recruitment, training, and employee management</span>
                        </li>
                        <li>
                            <i class="fa-regular fa-square-check"></i>
                            <span>Learn organizational behavior and HR practices</span>
                        </li>
                        <li>
                            <i class="fa-regular fa-square-check"></i>
                            <span>Gain insights into workforce planning and performance management</span>
                        </li>
                    </ul>
                </div>
                        ...
                        <div class="pgcs-top">
                            <div class="pgcs-left">
                                ...
                                <ul class="pgcs-course-list">
                                    ...
                                    <li>Compensation Management and HR Audit</li>
                                    <li>HRIS</li>
                                </ul>
                            </div>
                        </div><!-- /pgcs-top -->
                    ...
                    <div class="faq-list">
                        ...
                        <div class="faq-item is-open">
                            ...
                            <div class="faq-a" style="background: transparent;">
                                <p class="text-dark">Completing a certification course in human resource management can open up various career opportunities in different sectors, such as:</p>
                                <ul class="ac-list text-dark">
                                    <li>HR Executive</li>
                                    <li>Recruitment Coordinator</li>
                                    <li>Talent Acquisition Assistant</li>
                                </ul>
                            </div>
                        </div>
    ...
    <section class="sam-certificate-section" id="certificate">
        <div class="container">
            ...
            <div class="cert-img">
                <img class="img-fluid" src="assets-new/images/certificate/certification-in-human-resource-management_cer.webp" alt="Certification in Human Resource Management" loading="lazy">
            </div>
        </div>
    </section>
