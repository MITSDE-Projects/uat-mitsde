...
{
   echo $searchmsg="No student details found. Kindly contact student support for assistance.";
...
function sendtoreject(value, id) {
    // alert(id);
    // alert(value);
    window.location.href = 'OtherFeesPaymenticiciN.php?studentid=' + value;
            ...
            <div class="row d-flex justify-content-center">
                <div class="col-xl-7 col-lg-8 col-md-9 col-11 text-center">
                    ...
                    <div class="card">
                        ...
                        <h3>Fee Payment</h3>
                        <p class="blue-text"><b><?php echo $searchmsg; ?></b>
                        </p>
