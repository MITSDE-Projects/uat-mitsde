...
<title>Careere express</title>
<body>
    <div align="center"><h1>MITSDE - Career Express Collected Data</h1></div>
<table id="example" class="display" style="width:100%">
        ...
        <tbody>
          <?php 
          $i=1;
          $serch=mysql_query("SELECT * FROM `careerexpress` ORDER BY `careerexpress`.`id` DESC");
