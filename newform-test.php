...
if (isset($_GET['studentid'])) {
    ...
    if (mysql_num_rows($result) > 0) {
        ...
        // die();
        if ($row['flag'] == 1) {
            echo "</br></br><center><h1 style='color:red; margin-top:20px'>Make new payments from ERP</h1></center>";
            echo "</br><center><h3><a href='https://mitpro.mitsde.com/'>Go To ERP</a></h3></center>";
            exit;
        } else {
            header("Location: newform-test-step2.php?leadid=" . $StudentID); // go to next step
            exit;
        }
    }
}
...
<head>
    ...
    <script language="javascript" type="text/javascript">
        function checklead(value) {
            window.location.href = 'newform-test.php?studentid=' + value;
        }
    </script>
...
<body>
            ...
            <div class="row d-flex justify-content-center">
                <div class="col-xl-7 col-lg-8 col-md-9 col-11 text-center">
                    ...
                    <div class="card">
                        ...
                        <form action="newform-test-step2.php" name="OtherFeesPayment" id="OtherFeesPayment"
                            ...
                            <div class="row justify-content-between text-left">
                                <div class="form-group col-sm-6 flex-column d-flex mt-2">
                                    ...
                                    <input type="text" class="form-control" name="merchant_param3" id="merchant_param3"
                                        value="<?= $StudentID ?>" placeholder="Enter Admission ID"
                                        onchange="checklead(this.value);" style="text-transform:uppercase">
                                </div>
                            ...
                            <div class="row justify-content-between text-left">
                                ...
                                <div class="center mt-2">
                                    ...
                                    <button type="submit" id="mysubmitBtn" name="new_lead_submit" disabled="disabled"
                                        style="background: #f47521;width: 50%;color: #fff;"
                                        class="btn btn-primary mit-button">Submit</button>
                                </div>
                        </form>
    ...
    <script>
        function getSpecializations(courseValue) {
            ...
            var courseName = parts[0]; // Get the CourseName part
