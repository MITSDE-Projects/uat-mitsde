<nav class="navbar navbar-expand-lg fixed-top navigation">
    ...
    <div class="container">
        <a class="navbar-brand" href="../index"><img
                src="../assets/images/new/logo-mit-school-of-distance-education.png" width="auto" height="auto"
                alt="logo mit school of distance education">
        </a>
            ...
            <ul class="navbar-nav ms-auto">
                    ...
                    <ul class="dropdown-menu dropMenu" id="fixissue">
                        ...
                        <li class="nav-item dropdown secondnav">
                            ...
                            <ul class="dropdown-menu secondDrop" style="width: 320px;">
                                <li><a class="dropdown-item" href="../pg-diploma-in-project-management">PGDM in
                                        Project
                                        Management </a>
                                </li>
                                ...
                                <li><a class="dropdown-item" href="../pg-diploma-in-human-resource-management">PGDM
                                        in
                                        Human Resource
                                        Management</a></li>
                                <li><a class="dropdown-item" href="../pg-diploma-in-information-technology">PGDM in
                                        Information
                                        Technology</a></li>
                                <li><a class="dropdown-item" href="../pg-diploma-in-marketing-management">PGDM in
                                        Marketing
                                        Management</a></li>
                                <li><a class="dropdown-item" href="../pg-diploma-in-finance-management">PGDM in
                                        Finance
                                        Management</a>
                                </li>
                                <li><a class="dropdown-item" href="../pg-diploma-in-supply-chain-management">PGDM in
                                        ...
                                        Chain
                                        Management</a></li>
                                <li><a class="dropdown-item" href="../pg-diploma-in-material-management">PGDM in
                                        Material
                                        Management</a></li>
                        ...
                        <li class="nav-item dropdown secondnav">
                            ...
                            <ul class="dropdown-menu secondDrop" style="width: 255px;">
                                <li><a class="dropdown-item"
                                        href="../post-graduate-certificate-in-business-analytics">PGCM
                                        Business
                                        Analytics </a></li>
                                <li><a class="dropdown-item"
                                        href="../post-graduate-cetificate-in-digital-marketing">PGCM
                                        Digital
                                        Marketing</a></li>
                        ...
                        <li class="nav-item dropdown secondnav">
                            <a class="nav-link dropdown-toggle"
                                href="../post-graduate-diploma-in-business-administration" data-bs-toggle="dropdown"
                                aria-expanded="false">Post Graduate Diploma in Business
                                Administration</a>
                            <ul class="dropdown-menu secondDrop" style="width: 320px;">
                                <li><a class="dropdown-item" href="../pgdba-in-operations-management">PGDBA in
                                        Operations
                                        Management</a></li>
                                <li><a class="dropdown-item" href="../pgdba-in-finance">PGDBA in Finance
                                        Management</a>
                                </li>

                                <li><a class="dropdown-item" href="../pgdba-in-human-resource-management">PGDBA in
                                        Human
                                        Resource
                                        Management</a></li>
                                <li><a class="dropdown-item" href="../pgdba-in-information-technology">PGDBA in
                                        Information
                                        Technology</a></li>
                                <li><a class="dropdown-item" href="../pgdba-in-marketing-management">PGDBA in
                                        Marketing
                                        Management</a></li>
                        ...
                        <!-- cap -->
                        <li class="nav-item dropdown secondnav">
                            <a class="nav-link dropdown-toggle" href="#" data-bs-toggle="dropdown">Career
                                Accelerated
                                Programs (CAP)</a>
                            <ul class="dropdown-menu secondDrop" style="width: 255px;">
                        ...
                        <li class="nav-item dropdown secondnav">
                            <a class="nav-link dropdown-toggle" href="#" data-bs-toggle="dropdown"
                                aria-expanded="false">Professional Certificate Programs</a>
                            <ul class="dropdown-menu secondDrop" style="width: 320px;">
                                <li><a class="dropdown-item" href="../certification-in-project-management">Certification
                                        in
                                        Project Management</a></li>
                                <li><a class="dropdown-item"
                                        href="../certification-in-marketing-management">Certification
                                ...
                                <li><a class="dropdown-item"
                                        href="../certification-in-operations-management">Certification
                                        in Operations Management</a>
                                </li>

                                <li><a class="dropdown-item"
                                        href="../certification-in-material-management">Certification
                                        in Material Management</a></li>
                                <li><a class="dropdown-item"
                                        href="../certification-in-supply-chain-management">Certification in
                                        Logistics
                                        and Supply Chain</a></li>

                                <li><a class="dropdown-item" href="../certification-in-finance-management">Certification
                                        in
                ...
                <li class="nav-item dropdown firstNav">
                    ...
                    <ul class="dropdown-menu dropMenu">
                        ...
                        <li><a class="dropdown-item" href="../mit-office-of-career-services">MIT office of career
                                services
                            </a></li>
                        ...
                        <li><a class="dropdown-item" href="../aicte-feedback-facility">AICTE Feedback Facility</a>
                        </li>
                ...
                <!-- <li class="nav-item firstNav">
                    <a class="nav-link" style="width: max-content;" href="global-outreach">Global outreach</a>
                </li> -->
