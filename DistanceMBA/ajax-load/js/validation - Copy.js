...
function submitcontactvalidate(form_id,name) {
    if (is_submit) {
        var $inputs = $('#' + form_id + ' textarea, ' + '#' + form_id + ' :input, ' + '#' + form_id + ' select');// alert(is_submit);
            ...
            if (form_id == "menuContactform")
			 {
			   ...
			   var lead = {
                    ...
                    , "Mobile": $inputs[7].value
                    , "Email": $inputs[6].value
                    , "VendorToken": $inputs[9].value
                    , "CityName": "pune"
                    , "StateName": "Maharashtra"
                    , "CountryName": "India"
					, "Custom2": $inputs[8].value
					, "SourcePath": $inputs[10].value
					, "Address": $inputs[11].value
					, "Custom1": $inputs[12].value
