...
$result1 = mysql_query("SELECT * FROM uat_erp_transaction WHERE t_process_id = '" . $transactionId . "'");
            ...
            <div class="row d-flex justify-content-center">
                <div class="col-xl-7 col-lg-8 col-md-9 col-11 text-center">
                    ...
                    <div class="card">
                        ...
                        <form action="" name="OtherFeesPayment" id="OtherFeesPayment"
                            ...
                            <input type="hidden" name="redirect_url" id="redirect_url"
                                value="https://mitsde.com/uat-erp-ResponseHandler.php" />
                            ...
                            <div class="row justify-content-between text-left">
                                ...
                                <div class="form-group col-sm-6 flex-column d-flex mt-2">
                                    ...
                                    <select class="form-select form-select-md" name="merchant_param1"
                                        ...
                                        <?php
                                        $getCourses = mysql_query("SELECT * FROM `UatNewCourseERP`");
                                ...
                                <div class="form-group col-sm-6 flex-column mt-2" id="secondSpecializationDiv"
                                    ...
                                    <select class="form-select form-select-md" name="SecondSpecializationID"
                                        ...
                                        <option value="1">Emba</option>
                                        <option value="2">Emba2</option>
                                        <option value="3">Emba3</option>
                                    </select>
                                </div>
