...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    echo "</br><a href='https://www.mitsde.com/newform-test'>Go Back</a>";
...
if ($orchk > 0) {
    ...
    echo "<a href='https://www.mitsde.com/newform-test'>Go Back</a>";

    die;

} else {

    //echo "</br>INSERT INTO `temp_erp` (`T_ID`, `T_LeadID`,`student_name`,`email_id`,`phone`, `gender`, `course`,`SpecializationID`,`password`,`fees_type`, `T_installmentNo`, `T_A_Amount`, `T_B_Amount`, `tranID`, `P_Start_date`, `P_End_date`, `Status`,`gateway_name`, `new_counselorName`, `flag`) VALUES (NULL, '" . $LeadID . "','" . $student_name . "','" . $Email . "','" . $MobileNo . "','" . $gender . "', '" . $Course . "','" . $S_ID . "','" . $Password . "','" . $FeesType . "', '0', '0', '" . $totamt . "', '" . $transactionId . "', '" . $CurrentDateTime . "', NULL, 'processing', 'HDFC', '" . $new_counselorName . "', '0')";

    // die;

    $query = "INSERT INTO `temp_erp` (`T_ID`, `T_LeadID`,`student_name`,`email_id`,`phone`, `gender`, `course`,`SpecializationID`,`password`,`fees_type`, `T_installmentNo`, `T_A_Amount`, `T_B_Amount`, `tranID`, `P_Start_date`, `P_End_date`, `Status`,`gateway_name`, `new_counselorName`, `flag`) VALUES (NULL, '" . $LeadID . "','" . $student_name . "','" . $Email . "','" . $MobileNo . "','" . $gender . "', '" . $Course . "','" . $S_ID . "','" . $Password . "','" . $FeesType . "', '0', '0', '" . $totamt . "', '" . $transactionId . "', '" . $CurrentDateTime . "', NULL, 'processing', 'HDFC', '" . $new_counselorName . "', '0')";
