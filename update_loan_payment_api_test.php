...
//print_r($result);
    ...
    foreach ($result as $record) {
      ...
      //echo "</br>---------------------------------------------------------------";
                ...
                $getmarchanID = mysqli_query($conn,"SELECT memberID,amount,transactid,email FROM student01 WHERE email='".$student_Email_ID."'");
               ...
               $currentTime = date('Y-m-d H:i:s');
                ...
                $getmarchanID = mysqli_query($conn,"SELECT email,transaction_id FROM tbl_transactions_details1 WHERE email='".$email."' and transaction_id='".$instrument_No."'");
    ...
    <div class="col-12">
      <div class="card mt-3 tab-card">
        ...
        <tbody>
          <?php 
          $i=1;
          $serch=mysqli_query($conn,"SELECT * FROM `loanpaymentdata1` ORDER BY `loanpaymentdata1`.`id` DESC");
        ...
        <tbody>
          <?php 
          $i=1;
          $serch=mysqli_query($conn,"SELECT * FROM `loanpaymentdata1` WHERE `flag` = 0 ORDER BY `id` DESC");
