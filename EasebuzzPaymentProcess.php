...
$transactionId=$_POST['orderid'];
		          ...
		          $GetFeeType = mysql_query("SELECT * FROM `feehead_erp` WHERE `description` = '".$FeesType."'");
...
$posted['surl']="https://www.mitsde.com/EasebuzzPaymentResponse.php";
$posted['furl']="https://www.mitsde.com/EasebuzzPaymentResponse.php";
$posted['udf1']=$LeadID;
$posted['udf2']=$Course;
...
if(empty($posted['hash']) && sizeof($posted) > 0) {
	...
	if($orchk>0)
		  ...
		  echo "<a href='https://mitsde.com/OtherFeesPaymentByEaseBuzz.php'>Go Back</a>";
  ...
  <body onLoad="submitForm();" >
    ...
    <form action="<?php echo $action; ?>" method="post" name="easebuzzForm">
      ...
      <table>
        ...
        <tr>
          <!--<td>Success URI: </td>-->
          <td colspan="3"><input type="hidden"  name="surl" value="https://mitsde.com/EasebuzzPaymentResponse.php" size="64" /></td>
        </tr>
        <tr>
         <!-- <td>Failure URI: </td>-->
          <td colspan="3"><input type="hidden"  name="furl" value="https://mitsde.com/EasebuzzPaymentResponse.php" size="64" /></td>
        </tr>
        <tr>
