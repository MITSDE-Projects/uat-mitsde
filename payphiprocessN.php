 ...
 error_reporting(0);
   ...
   //die; 
	...
	$_POST['amount'];
	        ...
	        if( $_POST['billing_email'] != '' AND $_POST['delivery_tel'] != '' AND $_POST['amount']!= '' ) 
	         ...
	         else
	           {
	              ...
	              echo "</br><a href='https://www.mitsde.com/OtherFeesPaymenPayPhiN'>Go Back</a>";
	             die;  
	          }
	          }
	     else
	...
	if($orchk>0)
		  ...
		  echo "<a href='https://www.mitsde.com/OtherFeesPaymenPayPhiN'>Go Back</a>";
		  die;
		  }
		  else
		  {
...
$txnDate=date('Ymdhis');
$returnURL="https://mitsde.com/payresponseN.php";
//echo "</br>";
