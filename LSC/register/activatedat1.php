...
if(is_numeric($memberID) && !empty($active))
{
    ...
    if($ld!="T")
    {
	 ...
	 //echo "</br>2UPDATE student SET memberID='$ld', active = 'Yes' WHERE memberID = '$membID'";
	 $str="UPDATE student SET ERPLeadID='$ld',ReferralCode='$ReferralCode', active = 'Yes' WHERE memberID = '$membID'";
	...
	if(mysqli_query($connection, $query))
	{
		...
		header('Location: http://mitsde.com/LSC/register/index.php?action=active&src='.$_GET['src']);
		exit;
	...
	else
	{
		...
		?>
		<br>
		<a href="http://mitsde.com/LSC/register/index.php">Go To login page</a>
		<?php
	}
