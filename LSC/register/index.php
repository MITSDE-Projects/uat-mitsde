...
?>        
                 ...
                 <p></p><p>Username : <?=$_POST['email'];?></p><p>Password:<?=$_POST['password'];?></p><p>To activate your account, please click <a href='https://www.mitsde.com/LSC/register/activatedat.php?x=<?=$id?>&xz=<?=$_POST['phonenumber'];?>&y=<?=$activasion;?>&src=<?=$_SESSION['src']?>'>Here</a></p>
