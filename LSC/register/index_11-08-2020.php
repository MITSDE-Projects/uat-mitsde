...
?>        
                 ...
                 <p></p><p>Username : <?=$_POST['email'];?></p><p>Password:<?=$_POST['password'];?></p><p>To activate your account, please click <a href='https://www.mitsde.com/apply/register/activatedat.php?x=<?=$id?>&y=<?=$activasion;?>&src=<?=$_SESSION['src']?>'>Here</a></p>
                 ...
                 <?php
                   $body  = ob_get_clean();
                        ...
                        $mail->Subject = "MIT SDE: Registration 2020 / 21";
                        ...
                        $mail->MsgHTML($body);
                          ...
                          //$mail->AddBCC('sanjay.gaiwad@mitsde.com');
