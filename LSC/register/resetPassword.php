...
if(isset($_POST['submit'])){
	...
	if(!isset($error)){
		...
		try {
			...
			header('Location: https://www.mitsde.com/LSC/register/index.php?action=resetAccount');
			exit;
...
<table width="1000" border="0" align="center" cellpadding="0" cellspacing="0" >
  <tr>
	...
	<a href="https://www.mitsde.com/" target="_blank"><img src="https://www.mitsde.com/LSC/images/logo-1.png" width=200 height=80 style="float:left;"/></a>
