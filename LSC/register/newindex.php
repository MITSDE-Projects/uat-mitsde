...
?>        
                 ...
                 <p></p><p>Username : <?=$_POST['email'];?></p><p>Password:<?=$_POST['password'];?></p><p>To activate your account, please click <a href='https://www.mitsde.com/LSC/register/activatedat.php?x=<?=$id?>&y=<?=$activasion;?>&src=<?=$_SESSION['src']?>'>Here</a></p>
                 ...
                 <?php
                   $body  = ob_get_clean();
                        ...
                        $mail->Password   = "Nomitsde@123";            // GMAIL password
                        ...
                        $mail->Subject = "MIT SDE: Registration 2019";
                        ...
                        $mail->MsgHTML($body);
                          ...
                          $mail->AddBCC('abhishek.kalyana@mitsde.com');
                          $mail->AddBCC('admissions@mitsde.com');
			...
			$url="https://www.mitsde.com/register/activatedat.php?x=".$id."&y=".$activasion;
		...
		//	header('Location:https://www.mitsde.com/LSC/register/index.php?action=joined');
...
$.src="//v2.zopim.com/?217nWn22mzxPjb1AjNFKbZtfANy2PKbP";z.t=+new Date;$.
...
<link rel="canonical" href="https://www.mitsde.com/LSC/register/index.php" />
</head>
...
<body class="bg-pic" style="margin-top:-2px;margin-bottom:8px;">
   <div class="wrapper-640">
		...
		<div class="mheader">
		<a href="https://www.mitsde.com/" target="_blank"><img src="https://www.mitsde.com/LSC/images/logo-1.png" width=200 height=80 style="float:left;"/></a><br/>
...
<div style="" id="des-apt"></div>
   ...
   <div class="formcontainer">
       ...
       <h3 style="float:right;">New User? Register</h3>
			...
			<input name="name" type="text" id="name" style="margin-top:0px;font-size: 14px;" required  placeholder="First Name" value="<?=$_POST['name']?>">
                </div>
                <div class="col-sm-6">
                    <label style="left: 66%; top:-1px;" id="label-email">Last Name</label>
			<input name="lastname" type="text" id="lastname" style="margin-top:-14px;font-size: 14px;" required  placeholder="Last Name" value="<?=$_POST['lastname']?>">
                </div>
            </div>
