...
<head><meta http-equiv="Content-Type" content="text/html; charset=utf-8">
    <title>Admissions 2022-23</title>
...
//echo "IN2";    
  ...
  echo "<p>Congratulations!</p>
    ...
    <p><b>Please Find below details confirmed by you before making the payment:-</b></p>
                     ...
                     <p>2) Amount Paid –INR <b><?php echo '$Fees'; ?> /-</b></p>
  ...
  <center>
                    <div class="panel panel-default" >
                        ...
                        <div class="panel-body">
	                        ...
	                        <tr>
	                         <td>
	                           <input type="hidden" name='leadid' value="<?php echo $memberid; ; ?>"> 
                             <input type="hidden" name='emailid' value="<?php echo $_POST['email']; ?>">
                             <input type="hidden" name='phone' value="<?php echo $phonenumber;  ?>">
                             <input type="hidden" name='payfees' value="<?php echo $_POST['amount'];  ?>">
                             </td>
                             </tr>
<tr>
    <td>
