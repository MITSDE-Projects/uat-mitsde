...
<html>
  ...
  <tr>
    ...
    <!--<form action="OnlinePaymentPro.php" method="post" name="payuForm" style="margin-top:75px;">-->
        ...
        <form action="OnlinePaymentProTEST.php" method="post" name="payuForm" style="margin-top:75px;">
...
<html>
  ...
  <tr>
    ...
    <form action="easepayformsubmitTEST.php" method="post" name="payuForm" style="margin-top:75px;">
...
function generatetransactionid()
  ...
  //---------------------------------------------------create reponse url for course wise transation
      ...
      $response_url="https://www.mitsde.com/LSC/ccavResponseHandlerTEST.php";
...
?>
			...
			<form action="ccavRequestHandlerTEST.php" name="OtherFeesPayment" id="OtherFeesPayment" onSubmit="return validate(this);" method="post">
