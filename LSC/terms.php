...
<form id="form2" name="form2" method="post" action="#" style="margin-top:50px;width:100%;background: #fff;">
<!--<form id="form2" name="form2" method="post" action="register/index.php" style="margin-top:50px;width:100%;background: #fff;">-->
<center>	<input type="checkbox" required> <a href="http://www.avantikauniversity.edu.in/privacy-policy.php" target="_blank">Terms, Conditions and Privacy Policy.</a>  <br/>
           <input name="form3" type="submit" style="width: 300px;margin: auto;" class="txtheader2" id="form3" value="I accept terms and conditions" />
					 </center>
       </form>
