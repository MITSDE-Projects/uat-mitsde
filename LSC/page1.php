...
@media screen and (max-width: 786px) and (min-width: 320px) {
    ...
    #coursedtls{
        ...
        width:125% !important;
            ...
            <form action="page5.php" method="post" class="j-form" onsubmit="return validatepage1();">
...
<option value="" >--Select--</option>
<option value="Project Management" <? if($desciplines=='Project Management') { echo "SELECTED='SELECTED'"; }?> >Project Management</option>
<option value="Operations Management" <? if($desciplines=='Operations Management') { echo "SELECTED='SELECTED'"; }?> >Operations Management</option>
<option value="Human Resource Management" <? if($desciplines=='Human Resource Management') { echo "SELECTED='SELECTED'"; }?> >Human Resource Management</option>
<option value="Marketing Management" <? if($desciplines=='Marketing Management') { echo "SELECTED='SELECTED'"; }?> >Marketing Management</option>
<option value="Finance Management" <? if($desciplines=='Finance Management') { echo "SELECTED='SELECTED'"; }?> >Finance Management</option>
<option value="Logistics and Supply Chain Management" <? if($desciplines=='Logistics and Supply Chain Management') { echo "SELECTED='SELECTED'"; }?> >Logistics and Supply Chain Management</option>
<option value="Financial Management" <? if($desciplines=='Financial Management') { echo "SELECTED='SELECTED'"; }?> >Financial Management</option>
...
<option value="Retail Management" <? if($desciplines=='Retail Management') { echo "SELECTED='SELECTED'"; }?> >Retail Management</option>
