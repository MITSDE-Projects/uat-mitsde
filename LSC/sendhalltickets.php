...
$conn = mysqli_connect($DB_Server, $DB_Username, $DB_Password,$DB_DBName);
      //  $url="http://avantikauniversity.edu.in/LSC/printformvalue.php";
...
Team Avantika</p>";
	  ...
	  $body="<br><p>Dear ".$applicantdata["name"].",</p>
		...
		<a href='http://avantikauniversity.edu.in/LSC/printformvalue.php' target='_blank'>Download Hall Ticket</a>
...
echo "<td>".$body."</td></tr>";
    ...
    <div style="width:100%;float: right;">
        ...
        <img src="http://avantikauniversity.edu.in/LSC/images/logo.svg" style="width:100px;margin-right: 10px;"/>
        <img src="http://avantikauniversity.edu.in/LSC/images/mitid.jpg" style="width:240px;margin-right: 10px;"/>
        <img src="http://avantikauniversity.edu.in/LSC/images/mit.png" style="width:100px;margin-right: 10px;"/>
         <br>
    <br>
    <br> 
        </div>
   ...
   {
	$ht.=' <img src="http://avantikauniversity.edu.in/LSC/'.$applicantdata['photo_image'].'" height=120 alt="" width=120 style="width:120px;border:1px solid;margin-right: 10px;float: right;padding:10px;"/>';
