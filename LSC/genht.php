...
$sqlta = mysqli_query($conn,$ta);
   ...
   {
	$ht.=' <img src="http://mitsde.com/apply/'.$applicantdata['photo_image'].'" height=120 alt="" width=120 style="width:120px;border:1px solid;margin-right: 10px;float: right;padding:10px;"/>';
