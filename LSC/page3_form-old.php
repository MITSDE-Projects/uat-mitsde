    ...
    if (empty($_POST)){
      ...
      //  header("location: page2_form.php");//redirecting to second page
		...
		//function to extract array
			 ...
			 $str="UPDATE student SET  elective_b1='".$elective_b1."',elective_b2='".$elective_b2."',`address`='$address',`caddress`='$caddress',`ccity`='$ccity',`cstate`='$cstate',`ccountry`='$ccountry',`cpincode`='$cpincode',`pcity`='$pcity',`pstate`='$pstate',`pcountry`='$pcountry',`ppincode`='$ppincode',`parentfname`='$parentfname',`parentlname`='$parentlname',`relationshipwithapplicant`='$relationshipwithapplicant',`parentmobilenumber`='$parentmobilenumber',`parentemail`='$parentemail',`professionoftheparent`='$professionoftheparentx',annualincome='".$annualincome."',
			 `organizationdetails`='$organizationdetails',`mothername`='$mothername',`aadhar` ='$aadhar',`nationality`='$nationality',nationalityselect='$nationalityselect',`isComplete`=0,`parentisdcode`='$parentisdcode' WHERE `memberID`='$memberid'"; 
                ...
                <form name="page3" action="page4_insertdata.php" method="post" onsubmit="return validatepage3();">
                    ...
                    <!--    <th>Marks Obtained</th>
                        ...
                        <tr>
                            ...
                            <td><input name="school10"   tabindex=11 type="text" placeholder="School" required value="<?php echo $school10;?>" style="height:40px; background-color:#FFF;border:1px solid #606062;"></td>
							<td> <input name="examboardname10"   required tabindex=12 type="text"  id="address" placeholder="(eg.SSC,CBSE,ICSC,IB)" value="<?php echo $examboardname10;?>" style="height:40px; background-color:#FFF;border:1px solid #606062;"></td>
                        ...
                        <tr>
						 ...
						 <tr>
							...
							<td><input name="graduation" type="text"  tabindex=15 placeholder="College" value="<?php echo $graduation;?>" style="height:40px; background-color:#FFF;border:1px solid #606062;"></td>
						...
						<tr>
							...
							<td><input name="postgraduation" type="text"  tabindex=15 placeholder="College" value="<?php echo $postgraduation;?>" style="height:40px; background-color:#FFF;border:1px solid #606062;"></td>
						...
						<tr>
							...
							<td><input name="otherqualification" type="text"  tabindex=15 placeholder="College" value="<?php echo $otherqualification;?>" style="height:40px; background-color:#FFF;border:1px solid #606062;"></td>
...
<br>
	...
	<div style="clear:both"></div>
		 ...
		 <div class="sectionheading">
                    ...
                    <input name="companyname" type="text" required id="companyname" placeholder="Company Name"  value="<?php echo $companyname;?>" required>
                    </div>
 
                    <div class="dp">Work Experience<br />
                    <input name="experience" type="text" id="experience" placeholder="experience" value="<?php echo $experience;?>">
                    </div>
