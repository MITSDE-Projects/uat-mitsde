...
if( $_SERVER['REQUEST_METHOD'] == 'POST' ) {
    if( $_POST['form_name'] != '' AND $_POST['form_email'] != '' AND $_POST['Mobile'] != '' AND $_POST['form_post'] != '' AND $_POST['form_message'] != '' ) {
        ...
        $toemail = 'hr@mitsde.com'; // Receiver Email Address
        $toname = 'HR';                // Receiver Name
        ...
        if( $botcheck == '' ) {
            ...
            $sex = isset($sex) ? "Mobile: $sex<br><br>" : '';
            ...
            if( $sendEmail == true ):
                $message = 'We have <strong>successfully</strong> received your application. Our HR team will get back to you.';
                $status = "true";
            else:
