  ...
  <?php include "5-common-seo-tag-2.php" ?>
    ...
    <section class="hero ph-hero">
        <nav class="page-breadcrumb" aria-label="Breadcrumb">
            ...
            <a href="#">PGDM</a>
            <span class="pb-sep">/</span>
            <span class="pb-current">PG Diploma In Project Management</span>
        </nav>
        <div class="container">
            ...
            <div class="ph-layout">
                ...
                <div class="ph-left">
                    <h1 class="ph-heading">Online PGDM Course<br>In Project Management</h1>
                    <!-- <div class="ph-sub">
            ...
            <div class="ph-specs-wrap">
                <div class="ph-specs">
                    <a href="pg-diploma-in-project-management"><button class="ph-spec-pill is-active">Project Management</button></a>
    ...
    <section class="about-section pb-0" id="about">
        ...
        <div class="container">
            ...
            <p>
                Simply put, project management is the process of planning, organizing, and overseeing how and when
                certain goals are met. Project managers orchestrate all aspects of time-limited, discrete projects.
                In business, project management is an art, a skill, and a challenging job. Thus, the high profile,
                high-risk role demands professionals with multitasking ability, analytical thinking, and excellent
                communication skills.
            </p>

            <p>
                MITSDE's <a
                    href="https://blog.mitsde.com/how-a-pgdm-in-project-management-prepares-you-for-leadership-roles/"
                    class="text-orange">PG Diploma in Project Management</a> course is designed according to the
                curriculum of the Project Management Institute (PMI), by eminent trainers and experts. The course
                helps nurture project managers to play a pivotal role in the establishment of the scope of the
                project, and then oversee its progress until successful delivery.
            </p>
                ...
                <div class="learning-outcomes-right">
                    <ul class="learning-outcomes-list">
                        <li>
                            ...
                            <span>Learn the concept, philosophy and importance of Project Management</span>
                        </li>
                        <li>
                            <i class="fa-regular fa-square-check"></i>
                            <span>Understand the components of a project</span>
                        </li>
                        <li>
                            <i class="fa-regular fa-square-check"></i>
                            <span>Create projects and hands-on Microsoft Project and Jira</span>
                        </li>
                        <li>
                            <i class="fa-regular fa-square-check"></i>
                            <span>Learn project analysis, risk management and project audit techniques</span>
                        </li>
                        <li>
                            <i class="fa-regular fa-square-check"></i>
                            <span>Create project documents and reports</span>
                        </li>
                    </ul>
                </div>
                    ...
                    <div class="pgcs-card">
                        ...
                        <div class="pgcs-cert">
                            ...
                            <ul class="pgcs-cert-list">
                                ...
                                <li>Certified Professional Quantitative Research Analyst (CPQBA)</li>
                            </ul>
            ...
            <div class="faq-list">
                ...
                <div class="faq-item is-open">
                    <button class="faq-q" aria-expanded="true">
                        <span>What is the duration of the PGDM in Project Management program?</span>
                ...
                <div class="faq-item">
                    <button class="faq-q" aria-expanded="false">
                        <span>Who is eligible to apply for this PGDM in Project Management?</span>
                        <svg class="faq-chevron" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path d="M6 9l6 6 6-6" stroke="currentColor" stroke-width="2" stroke-linecap="round"
                                stroke-linejoin="round" />
                        </svg>
                ...
                <div class="faq-item">
                    ...
                    <div class="faq-a">
                        <p>Yes, MITSDE's PGDM in Project Management is offered by an AICTE-approved distance education institution, and the curriculum is periodically revised in line with AICTE guidelines and industry updates.</p>
                    </div>
                </div>
                ...
                <div class="faq-item">
                    ...
                    <div class="faq-a">
                        <p>The program spans 4 semesters (82 total credits) covering business management foundations, managerial economics and accounting, project planning and scheduling, resource and cost management, agile and hybrid project management, risk and quality management, procurement, and a final project — along with hands-on tools training in MS Project, Primavera, and JIRA.</p>
                    </div>
                </div>
                ...
                <div class="faq-item">
                    ...
                    <div class="faq-a">
                        <p>Graduates can pursue roles such as Project Coordinator, Project Scheduler, Project Manager, Senior Project Manager, and Project Planner across industries like IT, Pharmaceutical, Petrochemical, Construction, and Automotive.</p>
                    </div>
                </div>
                ...
                <div class="faq-item">
                    ...
                    <div class="faq-a">
                        <p>Non-credit certifications are included across semesters, including AI Readiness, AI Productivity, AI Automation, and AI Strategy certificates, plus certified analyst credentials (CPEA, CPDA, CPDSA, CPQBA).</p>
                    </div>
                </div>
