...
$ccEmails = ['sanjay.gaikwad@mitsde.com', 'vibha.mishra@mitsde.com ', 'raj.marathe@mitsde.com '];
...
if ($mail->Send()) {
    ...
    $emailquery = mysql_query("INSERT INTO email_tracker (id, emailid, pagename, email_status, data_time) VALUES (NULL, '" . $email . "', 'corporate-upskilling', 'success', '" . $DT . "')");
