 ...
 if(isset($_GET[studentid]))
{
 ...
 $StudentID=$_GET[studentid]; // test reg id MIT2023E04739
...
function sendtoreject(value, id) {
     alert(id);
     alert(value);
    window.location.href = 'OtherFeesPaymentHDFCN.php?studentid=' + value;
...
<body>
    ...
    <main class="main-body">
                    ...
                    <div class="card">
                        ...
                        <form action="ccavRequestHandler.php" name="OtherFeesPayment" id="OtherFeesPayment"
                            ...
                            <input type="hidden" name="redirect_url" id="redirect_url"
                                value="https://mitsde.com/ccavResponseHandlerN.php" />
       ...
       <input type="text" class="form-control" name="AdmissionID" id="AdmissionID" onChange="sendtoreject(this.value,this.id);" value="<?php echo $StudentID;  ?>" placeholder="Admission ID" style="text-transform:uppercase">
       <input type="hidden" class="form-control" name="merchant_param3" id="merchant_param3" value="<?php echo $leadid;  ?>" placeholder="Admission ID">
                                </div>
                            ...
                            <div class="row justify-content-between text-left mt-2">
                                ...
                                <div class="form-group col-sm-6 flex-column d-flex mt-2">
                                    <input type="text" class="form-control" name="programName" readonly  id="programName" value="<?php echo $programName; ?>" placeholder="Course Name">
