...
$workshop_amt = isset($_GET['workshop_amt']) ? trim($_GET['workshop_amt']) : '';
...
<head>
    ...
    <!-- CANONICAL TAG -->
    <link rel="canonical" href="https://mitsde.com/faculty-Workshop" />
    <!-- CANONICAL TAG -->
    ...
    <script type="text/javascript">
        ...
        function validate(form) {
            ...
            if (Prefix === "") {
                errors.push("Please Select Prefix");
            }
            ...
            <div class="row d-flex justify-content-center">
                <div class="col-xl-7 col-lg-8 col-md-9 col-11 text-center">
                    ...
                    <div class="card">
                        ...
                        <!-- faculty-workshop-RequestHandler.php -->
                        <form action="faculty-workshop-RequestHandler.php" name="facultyWorkshopFeesPayment"
                            id="facultyWorkshopFeesPayment" onsubmit="return validate(this);" method="post">
                            ...
                            <input type="hidden" name="redirect_url" id="redirect_url"
                                value="https://uat.mitsde.com/faculty-workshop-ResponseHandler.php" />
                            ...
                            <div class="row">
                                <div class="form-group d-flex gap-2 mb-3 align-items-center">
                                    ...
                                    <select class="form-select form-select w-auto" name="prefix" id="prefix">
                            ...
                            <div class="row">
                                <div class="form-group d-flex gap-2 mb-3">
                                    ...
                                    <input type="text" class="form-control" name="delivery_tel" id="MobileNo" value=""
                            ...
                            <!-- <div class="row">
                                    <div class="form-group d-flex flex-column flex-md-row gap-2 mb-3">
                                        <div class="w-100">
                                            <input type="text" class="form-control" name="regid" id="regid" value=""
                                                placeholder="STUDENT ID">
                                            <small class="text-muted">Only for MITSDE Student</small>
                                        </div>

                                        <div class="w-100">
                                            <select class="form-select form-select-md" name="experience"
                                                id="experience">
                            ...
                            <!-- <div class="form-group">
                                    <input type="hidden" class="form-control" name="merchant_param2" id="merchant_param2" value=""
                            ...
                            <div class="form-group">
                                <div id="statediv">
                                    <input type="hidden" class="form-control" name="amount" id="exampleInputPassword1"
                                        placeholder="Amount" value="<?php echo htmlspecialchars($workshop_amt, ENT_QUOTES, 'UTF-8'); ?>">
                                </div>
                            </div>
                            <input type="hidden" class="form-control" name="merchant_param3" id="merchant_param3"
                                value="<?php echo htmlspecialchars($pagename, ENT_QUOTES, 'UTF-8'); ?>">
                        ...
                        <script type="text/javascript">
                            $("#facultyWorkshopFeesPayment").validate({
                        ...
                        <!-- <div class="row" style="padding-top: 15px;">
                            <div class="col-sm-4"><a href="#" target="_blank">Terms and condition</a></div>
                            <div class="col-sm-4"><a href="#" target="_blank">Terms of use</a></div>
                            <div class="col-sm-4"><a href="#" target="_blank">Privacy policy</a></div>
                        </div> -->
