...
//die;
...

	           {
	              ...
	              echo "</br><a href='https://www.mitsde.com/new-admission-form-payment'>Go Back</a>";
...
//	die;
	 ...
	 //  end
	   ...
	   */
        ...
        $orchk = mysql_num_rows(mysql_query("select * from New_student_admission_transaction where `t_process_id`='".$transactionId."'"));
	...
	if($orchk>0)
		  ...
		  echo "<a href='https://www.mitsde.com/new-admission-form-payment'>Go Back</a>";
