        ...
        <section>
            <div class="d-flex justify-content-center align-items-center p-5">
                <div class="col-md-6 col-lg-6 bg-dark p-3 " style="border-radius: 5px;">
                    <h4 class="text-white">Apply Now <a href="tel:9112-207-207"
                    ...
                    <form action="thankyou.php" method="post" class="reservation-form mt-20 myFormH"
                            ...
                            <div class="form-check">
                                ...
                                <small class="text-white">I authorize MIT-SDE representative to contact me,this will
                                    override
                                    DND/NDNC
                                    registry.</small>
                            </div>
                ...
                <div class="row d-flex justify-content-center">
                    ...
                    <div class="col-md-6 col-6 pink">
                        ...
                        <ul>
                            ...
                            <li><a class="dropdown-item" href="applicataion-process.php" target="_blank">Admissions</a>
                            </li>
                            ...
                            <li><a class="dropdown-item" href="https://myaccount.mitsde.com/" target="_blank">My
                                    Account</a></li>
                            <li><a class="dropdown-item" href="refer-friend.php" target="_blank">Refer a Friend</a></li>
                            ...
                            <li><a class="dropdown-item" href="hire-from-mitsde" target="_blank">Hire From Mitsde</a>
                            </li>
                ...
                <div class="cc-list">
                    ...
                    <div class="cc-details mt-3">
                        <span class="mtsk-phone">
                            <a href="tel:+91 9112207207" style="text-decoration: none; color: black;">+91
                                9112-207-207</a>
                        ...
                        <span class="mtsk-phone">
                            <a href="tel:+91 9028258800" style="text-decoration: none; color: black;">+91
                                9028-258-800</a>
                        </span>
            ...
            <div class="row res-row mt-5 me-auto">
                ...
                <div class="col-md-12 col-lg-4  courses-list">
                    <div class="cc-list">
                        <h2>Our Programs</h2>
                        <ul>
                            <!-- <li><a class="dropdown-item" href="pgdm-mba-dual-degree-program">Dual Specialisation - PGDM And EMBA</a></li> -->
                            <!-- <li><a class="dropdown-item" href="executive-mba">Executive MBA</a></li> -->
                            <li><a class="dropdown-item" href="post-graduate-certificate-in-management">Post Graduate
                                    Certificate in
                                    Management</a></li>
                            <li><a class="dropdown-item" href="post-graduate-diploma-in-management-executive">Post
                                    Graduate Diploma in Management
                                    (Executive)</a></li>
                            <li> <a class="dropdown-item" href="post-graduate-diploma-in-management">Post Graduate
                                    Diploma in
                                    Management</a></li>
                    ...
                    <div class="cc-list">
                        ...
                        <ul>
                            ...
                            <li>
                                ...
                                <a class="dropdown-item" href="online-pgdm-colleges-in-bangalore" target="_blank">PGDM
                ...
                <div class="col-md-12 col-lg-3 courses-list">
                    <div class="cc-list">
                        ...
                        <ul>
                            ...
                            <li><a class="dropdown-item" href="advanced-certificate-in-ui-ux">Advanced Certificate In UI
                                    UX</a></li>

                            <li><a class="dropdown-item" href="ai-in-digital-marketing">AI in Digital Marketing</a></li>
