...
echo "</br>student_id-->". $StudentID=$_GET[studentid]; // test reg id MIT2023E04739 test for live MIT2023E00097
 //die;
...
<script language="javascript" type="text/javascript">
     ...
     function sendtoreject(value,id)
     {
	   // alert(id);
	   // alert(value);
	   window.location.href='OtherFeesPaymenPayPhiN.php?studentid='+value; 
...
<head>
    ...
    <link rel="canonical" href="https://mitsde.com/OtherFeesPaymenPayPhi" />
    ...
    <meta property="og:title" content="Online Payment | Other Fees Payment By PayPhi | Pay Online">
    <meta property="og:site_name" content="MIT School of Distance Education">
    <meta property="og:url" content="https://mitsde.com/OtherFeesPaymenPayPhi">
...
<body>
            ...
            <div class="row d-flex justify-content-center">
                <div class="col-xl-7 col-lg-8 col-md-9 col-11 text-center">
                    ...
                    <div class="card">
                        ...
                        <h3>Fee Payment</h3>
                    <p class="blue-text"><b>Enter Only Admission ID. We Will get your information from database.</b></p>
                        <form action="payphiprocessN.php" name="OtherFeesPayment" id="OtherFeesPayment"
                                ...
                                <input type="hidden" name="redirect_url" id="redirect_url"
                                    value="https://mitsde.com/ccavResponseHandler0.php" />
                            ...
                            <div class="row justify-content-between text-left">
                                ...
                                <input type="text" class="form-control" name="AdmissionID"
                                        ...
                                        <input type="hidden" class="form-control" name="merchant_param3"
                                            id="merchant_param3" value="<?php echo $leadid;  ?>"
                                ...
                                <input type="text" class="form-control" name="delivery_name"
                                            readonly id="StudentName" value="<?php echo $FirstName.' '.$LastName; ?>"
                            ...
                            <div class="row justify-content-between text-left mt-2">
                                <div class="form-group col-sm-6 flex-column d-flex"> <input type="hidden" class="form-control" name="billing_email"
                                            readonly id="EmailID" value="<?php echo $EmailID; ?>"
                                            placeholder="Email ID">
                                </div>


                                <div class="form-group col-sm-6 flex-column d-flex mt-2"> <div class="form-group"><input type="hidden" class="form-control" name="delivery_tel"
                                            readonly id="MobileNo" value="<?php echo $MobileNumber; ?>"
                                            placeholder="Mobile No"> </div>
                                </div>
                                <div class="form-group col-sm-6 flex-column d-flex mt-2">
                                <input type="text" class="form-control"
                                            name="merchant_param1" readonly id="merchant_param1"
                                            value="<?php echo $SpecializationName; ?>" placeholder="Course Name"> 
                                </div>
                                ...
                                <select class="form-select form-select-md " aria-label="Small select example" onChange="geturlval(this.value,this.id);"
                                            class="form-control" name="merchant_param2" id="FeesType"
    ...
    <button type="submit" onclick="myfunction()" style="width: 50%;" class="btn btn-primary mit-button">Pay Now</button>
</div>
