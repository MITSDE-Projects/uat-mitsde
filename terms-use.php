...
<head>
    ...
    <title>Terms of Use | MITSDE</title>
    <meta name="description" content="Read the Terms of Use for MIT School of Distance Education website. Understand the user agreement, responsible use, limitation of liability, and governing law." />
    <meta name="keywords" content="MITSDE terms of use, MIT School of Distance Education user agreement, MITSDE website terms, distance education terms and conditions, MITSDE Pune" />

    <link rel="canonical" href="https://mitsde.com/terms-use" />
    ...
    "itemListElement": [
        ...
        { "@type": "ListItem", "position": 2, "name": "Terms of Use", "item": "https://mitsde.com/terms-use" }
    ]
    }
    </script>
...
<section class="hero ph-hero">
    ...
    <nav class="page-breadcrumb" aria-label="Breadcrumb">
        ...
        <span class="pb-current">Terms of Use</span>
    </nav>

    <div class="container">
        <div class="ph-layout py-5">
            <div class="ph-left">
                <h1 class="ph-heading">Terms of <span class="text-orange">Use</span></h1>
            </div>
            <div class="ph-right">
                <img src="assets-new/images/application-process.webp" alt="Terms of Use" />
            </div>
        </div>
    </div>
...
<section class="about-section" id="about">
    <div class="container">
        ...
        <h3 class="fw-bold mb-3">Responsible Use and Conduct</h3>
        ...
        <p>You are solely responsible for any consequences, losses, or damages that we may directly or indirectly incur or suffer due to any unauthorized activities conducted by you, as explained above, and may incur criminal or civil liability.</p>
        ...
        <h3 class="fw-bold mb-3">Limitation of Liability</h3>
        <p>In conjunction with the Limitation of Warranties as explained above, you expressly understand and agree that any claim against us shall be limited to the amount you paid, if any, for use of products and/or services. www.mitsde.com will not be liable for any direct, indirect, incidental, consequential or exemplary loss or damages which may be incurred by you as a result of using our Resources, or as a result of any changes, data loss or corruption, cancellation, loss of access, or downtime to the full extent that applicable limitation of liability laws apply.</p>

        <hr class="my-5" />

        <!-- Copyrights / Trademarks -->
        <h3 class="fw-bold mb-3">Copyrights / Trademarks</h3>
        <p>All content and materials available on www.mitsde.com, including but not limited to text, graphics, website name, code, images and logos are the intellectual property of MIT School of Distance Education and are protected by applicable copyright and trademark law. Any inappropriate use, including but not limited to the reproduction, distribution, display or transmission of any content on this site is strictly prohibited, unless specifically authorized by MIT School of Distance Education.</p>

        <hr class="my-5" />

        <!-- Termination of Use -->
        <h3 class="fw-bold mb-3">Termination of Use</h3>
        ...
        <!-- Governing Law -->
        <h3 class="fw-bold mb-3">Governing Law</h3>
        <p>This website is controlled by MIT School of Distance Education from our office located in the state of Maharashtra, India. It can be accessed by most of the states in India. As each state has laws that may differ from those of Maharashtra, India by accessing our website, you agree that the statutes and laws of Maharashtra, India without regard to the conflict of laws. Furthermore, any action to enforce this User Agreement shall be brought in the federal or state courts located in Maharashtra, India. You hereby agree to personal jurisdiction by such courts, and waive any jurisdictional, venue, or inconvenient forum objections to such courts.</p>

        <hr class="my-5" />

        <!-- Guarantee -->
        <h3 class="fw-bold mb-3">Guarantee</h3>
        <p>Unless otherwise expressed www.mitsde.com expressly disclaims all warranties and conditions of any kind, whether express or implied, including, but not limited to the implied warranties and conditions of merchantability, fitness for a particular purpose and non-infringement.</p>
        ...
        <!-- Website Disclaimer -->
        <h3 class="fw-bold mb-3">Website Disclaimer</h3>
        <p>The information on this website has general information only. The information is provided by www.mitsde.com, a property of MIT School of Distance Education. While we endeavour to keep the information up to date and correct, we make no representations or warranties of any kind, express or implied, about the completeness, accuracy, reliability, suitability or availability with respect to the website or the information, products, services, or related graphics contained on the website for any purpose. Any reliance you place on such information is therefore strictly at your own risk.</p>
        <p>In no event MITSDE will be liable for any loss or damage including without limitation, indirect or consequential loss or damage, or any loss or damage whatsoever arising from loss of data or profits arising out of, or in connection with, the use of this website. Through this website you are able to link to other websites which are not under the control of MITSDE. We have no control over the nature, content and availability of those sites. The inclusion of any links does not necessarily imply a recommendation or endorse the views expressed within them. Every effort is made to keep the website up and running smoothly. However, MITSDE takes no responsibility for, and will not be liable for, the website being temporarily unavailable due to technical issues beyond our control.</p>
