...
<head>
    ...
    <link rel="canonical" href="https://mitsde.com/DownloadBrochure" />
    ...
    <meta property="og:url" content="https://mitsde.com/DownloadBrochure">
            ...
            <div class="row d-flex justify-content-center">
                <div class="col-xl-7 col-lg-8 col-md-9 col-11 text-center">
                    ...
                    <div class="card " id="card1">
                        <h5 class="text-center mb-4">Brochure Request</h5>
                        <form action="DownloadBrochureLink.php" class="myForm" method="post" class="reservation-form mt-20"
                            ...
                            <input name="Divice" type="text" value="<?php echo $divice; ?>"  />
					   <input name="PageName" type="text" value="<?php echo $pagename; ?>"  />
