...
<body>
    <div align="center"><h1>MITSDE - Value Added Course_KPMG</h1></div>
<table id="example" class="display" style="width:100%">
        ...
        <tbody>
          <?php 
          $i=1;
          $serch=mysql_query("SELECT name,email,phone,amount,PayU_ID,API_DT,leadID,payment_confirmation_status,UTRNO,FeesType FROM `OtherFeesTransaction` WHERE `FeesType`='Value Added Course_KPMG' ORDER BY `OtherFeesTransaction`.`API_DT` DESC");
