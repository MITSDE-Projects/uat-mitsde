...
<head>
    ...
    <meta name="description"
        content="Distance Executive PGDM in Global Logistics & Supply Chain Management is the perfect solution for professionals looking to enter the global logistics market." />

    <meta name="keywords"
        content="executive distance courses, post graduate diploma in global logistics supply chain management, pg diploma in supply chain management, online mba in supply chain management" />
    ...
    <meta property="og:image"
        content="https://mitsde.com/assets/images/course/pgdm-exe/PGDM-Executive-Global-Logistics-&-Supply-Chain-Management.jpg">
            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-12 col-lg-6 main-banner">
                        <h1>PGDM Executive In Global Logistics & Supply Chain
                            Management</h1>
                        <p>Drive the profits through an effective supply chain and win the hearts of customers
                            with logistical excellence. </p>
                        <div class="page-btn">
                        ...
                        <div>
                            <nav>
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item active" aria-current="page">Global Logistics & Supply
                                        Chain
                                        Management
                                    </li>
                    ...
                    <div class="col-md-12 col-lg-6">
                        <div class="css-details">
                            <div class="stc-det student-sec inner-sec">
                                <img src="assets/images/course/pgdm-exe/PGDM-Executive-Global-Logistics-&-Supply-Chain-Management_Icon-1.jpg"
                                    alt="Logistics and Supply Chain Management icon 1">
                            </div>
                            <img src="assets/images/course/pgdm-exe/PGDM-Executive-Global-Logistics-&-Supply-Chain-Management.jpg"
                                class="banner-img" alt="PGDM-Executive-Global-Logistics-&-Supply-Chain-Management">
                            <div class="stc-det course-sec inner-sec">
                                <img src="assets/images/course/pgdm-exe/PGDM-Executive-Global-Logistics-&-Supply-Chain-Management_Icon-2.jpg"
                                    alt="Logistics and Supply Chain Management icon 2">
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-md-8 col-lg-8 fintech-certi fin-feature hero11">
                        <p>
                            <b>Supply Chain Management (SCM)</b> is the discipline that encompasses the
                            end-to-end business activities carried out in any business, independent of the
                            manufacturing or service sector. SCM evolved over the years from multiple business
                            streams, one stream runs right from traditional transport management, to the latest
                            discipline logistic management; the other stream runs from traditional purchase
                            management to procurement or sourcing management. And the third stream can be
                            referred to as manufacturing management where it has evolved from mass production to
                            mass customization or Lean Production system including agile or flexible and quick
                            response Manufacturing Management.
                        </p>

                        <p>
                            The <b>Post Graduate Executive Program in Global Logistics and Supply Chain
                                Management</b> focuses on the key aspects of supply chain management while
                            incorporating the tools, best practices and the latest developments in the sector
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-md-12 col-lg-8 fin-feature1 hero11">
                        ...
                        <li><span class="newright-icon1"></span> Learn to design the best supply chain process for the
                            organization</li>
                        <li><span class="newright-icon1"></span> Understand the global supply chain best practices for
                            achieving excellence</li>
                        <li><span class="newright-icon1"></span> Learn the use of analytical software to minimize risk
                            and optimize profits</li>
                        <li><span class="newright-icon1"></span> Learn to integrate procurement, operations, logistics
                            and technology</li>
                        <li><span class="newright-icon1"></span> Understand the application of AI and Machine Learning
                            in Supply Chain and
                            Logistics
                                            ...
                                            <ul class="fin-feature2" style="list-style: none;">
                                                <div class="row">
                                                    <div class="col-md-6">
                                                        ...
                                                        <li><span class="newright-icon1"></span> Logistic Manager</li>
                                                        <li><span class="newright-icon1"></span> Warehouse Manager</li>


                                                    </div>
                                                    <div class="col-md-6">
                                                        <li><span class="newright-icon1"></span> Vendor Manager</li>
                                                        <li><span class="newright-icon1"></span> Supply chain management
                                                            consultant</li>
                                                        <li><span class="newright-icon1"></span> Procuremnet Manager
                                                        </li>
                            ...
                            <div class="accordion-item">
                                ...
                                <h2 class="accordion-header">
                                    ...
                                    <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                                        ...
                                        What is the duration of the PGDM Executive in Global Logistics & Supply Chain
                                        Management program?
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-12 col-lg-12">
                                                ...
                                                <div class="fintech-module alert brandcolor">
                                                    ...
                                                    <p>The program aims to equip students with the skills
                                                        to drive profits through effective supply chain
                                                        management and achieve logistical excellence.</p>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-12 col-lg-12">
                                                ...
                                                <div class="fintech-module alert brandcolor">
                                                    ...
                                                    <p>Graduates can pursue leadership roles in supply
                                                        chain management, logistics coordination, procurement,
                                                        and operations management across various industries.
                                                    </p>
                            ...
                            <div class="accordion-item">
                                ...
                                <h2 class="accordion-header">
                                    ...
                                    <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                                        ...
                                        Is the program suitable for professionals from non-logistics backgrounds?
                                            ...
                                            <div class="col-md-12 col-lg-12">
                                                ...
                                                <div class="fintech-module alert brandcolor">
                                                    ...
                                                    <p>Yes, the program is designed to provide foundational
                                                        and advanced knowledge in logistics and supply
                                                        chain management, making it suitable for professionals
                            ...
                            <div class="accordion-item">
                                ...
                                <h2 class="accordion-header">
                                    ...
                                    <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                                        ...
                                        What makes this program unique compared to other supply chain management
                                        programs?
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-12 col-lg-12">
                                                ...
                                                <div class="fintech-module alert brandcolor">
                                                    ...
                                                    <p>The program focuses on global logistics and
                                                        supply chain strategies, tailored for experienced
                                                        professionals, and offers the flexibility of
                                                        online learning.</p>
