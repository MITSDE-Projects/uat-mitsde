...
<div class="modal-dialog modal-lg">
    <div class="modal-content">
        <div class="modal-header">
            <h2 class="modal-title fs-5" id="enquiryModal-download-form">Enquire Now <a href="tel:9112207207"
                    style="text-decoration: none; color: #F47521">9112207207</a></h2>
            <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
        </div>
        <div class="modal-body">
            <div class="row">
                <div class="col-md-12 col-lg-5 modal-img">
                    <img src="assets/images/enquirey.png" class="img-fluid" title="PGDM Enquire Now" alt="Student enquiry and contact form illustration">
                </div>
                <div class="col-md-12 col-lg-7">
                    <form action="DownloadBrochureLink-digital-marketing-strategist.php" class="myFormP" method="post" name="menuContactformone"
